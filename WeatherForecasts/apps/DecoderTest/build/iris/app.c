...
extern void *memset(void *arg_0x2b0405b55020, int arg_0x2b0405b55288, size_t arg_0x2b0405b55530);
...
typedef int (*__compar_fn_t)(const void *arg_0x2b0405b74838, const void *arg_0x2b0405b74b10);
...
static void HplAtm1281Timer1P__CompareA__default__fired(void );
...
#line 60
static void HplAtm1281Timer1P__Capture__default__captured(HplAtm1281Timer1P__Capture__size_type t);
# 58 "/opt/tinyos-2.1.2/tos/chips/atm128/timer/HplAtm128Compare.nc"
...
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static error_t DecoderTestP__AMSend__send(am_addr_t addr, 
#line 71
message_t * msg, 
...
DecoderTestP__Packet__getPayload(
#line 121
message_t * msg, 
...
uint8_t len);
#line 106
static uint8_t DecoderTestP__Packet__maxPayloadLength(void );
# 67 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
static error_t DecoderTestP__decoderTask__postTask(void );
# 61 "/opt/tinyos-2.1.2/tos/interfaces/Leds.nc"
static void DecoderTestP__Leds__led0Off(void );
...
static void DecoderTestP__Leds__led1On(void );




static void DecoderTestP__Leds__led1Off(void );
#line 94
static void DecoderTestP__Leds__led2Off(void );
#line 56
static void DecoderTestP__Leds__led0On(void );
#line 89
static void DecoderTestP__Leds__led2On(void );
# 72 "DecoderTestP.nc"
enum DecoderTestP____nesc_unnamed4338 {
#line 72
...
bool DecoderTestP__locked = FALSE;
bool DecoderTestP__temp = FALSE;
bool DecoderTestP__temp2 = FALSE;
message_t DecoderTestP__packet;

message_t DecoderTestP__tmpPacket;
message_t *DecoderTestP__tmpPtr = &DecoderTestP__tmpPacket;
...
static inline void HplAtm1281Timer1P__CompareA__default__fired(void );
...
static inline void HplAtm1281Timer1P__Capture__default__captured(uint16_t time);
...
enum /*LocalTimeMicroC.TransformCounterC*/TransformCounterC__0____nesc_unnamed4341 {
...
enum /*CounterMicro32C.Transform32*/TransformCounterC__1____nesc_unnamed4360 {
...
# 83 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x2b04065e4da0){
#line 83
    /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x2b04065e4da0);
#line 83
}
#line 83
# 67 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
...
#line 173
{
  if (&DecoderTestP__packet == bufPtr) {
      DecoderTestP__locked = FALSE;
    }
}
...
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static void /*SerialActiveMessageC.AM*/SerialActiveMessageP__0__AMSend__sendDone(am_id_t arg_0x2b04060ab020, message_t * msg, error_t error){
#line 110
  switch (arg_0x2b04060ab020) {
#line 110
    case AM_DDCTESTMSG:
#line 110
...
#line 110
    default:
#line 110
      /*SerialActiveMessageC.AM*/SerialActiveMessageP__0__AMSend__default__sendDone(arg_0x2b04060ab020, msg, error);
#line 110
      break;
#line 110
    }
...
# 100 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
inline static void /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__Send__sendDone(uart_id_t arg_0x2b0406218748, message_t * msg, error_t error){
#line 100
  switch (arg_0x2b0406218748) {
#line 100
...
#line 100
    default:
#line 100
      /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__Send__default__sendDone(arg_0x2b0406218748, msg, error);
#line 100
      break;
#line 100
    }
...
inline static void DecoderTestP__Leds__led1Off(void ){
#line 77
...
inline static void DecoderTestP__Leds__led1On(void ){
#line 72
  LedsP__Leds__led1On();
#line 72
}
...
#line 154
{
  message_t *tmp = DecoderTestP__tmpPtr;

#line 156
  DecoderTestP__tmpPtr = bufPtr;
  bufPtr = tmp;

  if (!DecoderTestP__temp) {
      DecoderTestP__Leds__led1On();
      DecoderTestP__temp = TRUE;
    }
  else 
#line 162
    {
      DecoderTestP__Leds__led1Off();
      DecoderTestP__temp = FALSE;
    }
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * /*SerialActiveMessageC.AM*/SerialActiveMessageP__0__Receive__receive(am_id_t arg_0x2b04060c8158, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x2b04060c8158) {
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = /*SerialActiveMessageC.AM*/SerialActiveMessageP__0__Receive__default__receive(arg_0x2b04060c8158, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__Receive__receive(uart_id_t arg_0x2b04061f9c38, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x2b04061f9c38) {
#line 78
    case TOS_SERIAL_ACTIVE_MESSAGE_ID:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__Receive__default__receive(arg_0x2b04061f9c38, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 31 "/opt/tinyos-2.1.2/tos/lib/serial/SerialPacketInfo.nc"
inline static uint8_t /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__upperLength(uart_id_t arg_0x2b0406216aa8, message_t *msg, uint8_t dataLinkLen){
#line 31
  unsigned char __nesc_result;
#line 31

#line 31
  switch (arg_0x2b0406216aa8) {
#line 31
    case TOS_SERIAL_ACTIVE_MESSAGE_ID:
#line 31
...
#line 31
    default:
#line 31
      __nesc_result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__default__upperLength(arg_0x2b0406216aa8, msg, dataLinkLen);
#line 31
      break;
#line 31
    }
...
inline static uint8_t /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__offset(uart_id_t arg_0x2b0406216aa8){
#line 15
  unsigned char __nesc_result;
#line 15
...
#line 15
    default:
#line 15
      __nesc_result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__default__offset(arg_0x2b0406216aa8);
#line 15
      break;
#line 15
    }
...
inline static void DecoderTestP__Leds__led2Off(void ){
#line 94
...
inline static void DecoderTestP__Leds__led2On(void ){
#line 89
  LedsP__Leds__led2On();
#line 89
}
...
# 23 "/opt/tinyos-2.1.2/tos/lib/serial/SerialPacketInfo.nc"
inline static uint8_t /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__dataLinkLength(uart_id_t arg_0x2b0406216aa8, message_t *msg, uint8_t upperLen){
#line 23
  unsigned char __nesc_result;
#line 23
...
#line 23
    default:
#line 23
      __nesc_result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__default__dataLinkLength(arg_0x2b0406216aa8, msg, upperLen);
#line 23
      break;
#line 23
    }
...
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t DecoderTestP__AMSend__send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80
...
inline static uint8_t DecoderTestP__Packet__maxPayloadLength(void ){
#line 106
  unsigned char __nesc_result;
#line 106
...
inline static void DecoderTestP__Leds__led0On(void ){
#line 56
  LedsP__Leds__led0On();
#line 56
}
#line 56
# 126 "/opt/tinyos-2.1.2/tos/interfaces/Packet.nc"
inline static void * DecoderTestP__Packet__getPayload(message_t * msg, uint8_t len){
#line 126
  void *__nesc_result;
#line 126
...
#line 72
{
  ...
  uint8_t maxIndex;
  uint32_t startTime;
  DdcForecastMsg *cc = (DdcForecastMsg *)DecoderTestP__tmpPtr->data;

#line 77
  startTime = DecoderTestP__LocalTime__get();
  DecoderTestP__Decoder__decode(&DecoderTestP__fcastRes, cc);
  startTime = DecoderTestP__LocalTime__get() - startTime;

  if (DecoderTestP__locked) {
      return;
    }
  else {
      DdcTestMsg *rcm = (DdcTestMsg *)DecoderTestP__Packet__getPayload(&DecoderTestP__packet, sizeof(DdcTestMsg ));


      if (rcm == (void *)0) {
          DecoderTestP__Leds__led0On();
          return;
        }

      if (DecoderTestP__Packet__maxPayloadLength() < sizeof(DdcTestMsg )) {
          return;
        }


      __nesc_hton_uint32(rcm->decodingTime.nxdata, startTime);
      __nesc_hton_uint8(rcm->numValues.nxdata, DecoderTestP__fcastRes.numValues);
      __nesc_hton_uint8(rcm->sunrise.nxdata, DecoderTestP__fcastRes.sunrise);
      __nesc_hton_uint8(rcm->sunset.nxdata, DecoderTestP__fcastRes.sunset);
      maxIndex = DecoderTestP__fcastRes.numValues >> 1;
      for (i = 0; i < maxIndex; i++) 
        {
          __nesc_hton_uint8(rcm->values[i].nxdata, (DecoderTestP__fcastRes.values[2 * i] << 4) + DecoderTestP__fcastRes.values[2 * i + 1]);
        }
      ...
      if (DecoderTestP__AMSend__send(AM_BROADCAST_ADDR, &DecoderTestP__packet, sizeof(DdcTestMsg )) == SUCCESS) {

          if (!DecoderTestP__temp2) {
              DecoderTestP__Leds__led2On();
              DecoderTestP__temp2 = TRUE;
            }
          else 
#line 119
            {
              DecoderTestP__Leds__led2Off();
              DecoderTestP__temp2 = FALSE;
            }
          DecoderTestP__locked = TRUE;
        }
    }
}
...
# 61 "/opt/tinyos-2.1.2/tos/interfaces/Leds.nc"
inline static void DecoderTestP__Leds__led0Off(void ){
#line 61
...
#line 72
# 225 "/opt/tinyos-2.1.2/tos/chips/atm1281/timer/HplAtm1281Timer1P.nc"
static inline void HplAtm1281Timer1P__CompareA__default__fired(void )
#line 225
{
}
...
#line 58
  HplAtm1281Timer1P__CompareA__default__fired();
#line 58
}
#line 58
...
#line 58
# 237 "/opt/tinyos-2.1.2/tos/chips/atm1281/timer/HplAtm1281Timer1P.nc"
static inline void HplAtm1281Timer1P__Capture__default__captured(uint16_t time)
#line 237
{
}
...
#line 60
  HplAtm1281Timer1P__Capture__default__captured(t);
#line 60
}
#line 60
...
# 75 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
static void SchedulerBasicP__TaskBasic__runTask(uint8_t arg_0x2b0405ca6ab0){
#line 75
  switch (arg_0x2b0405ca6ab0) {
#line 75
...
#line 75
    default:
#line 75
      SchedulerBasicP__TaskBasic__default__runTask(arg_0x2b0405ca6ab0);
#line 75
      break;
#line 75
    }
