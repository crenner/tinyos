...
extern int memcmp(const void *arg_0x2b1f94720de8, const void *arg_0x2b1f9471f100, size_t arg_0x2b1f9471f3a8);
extern void *memcpy(void *arg_0x2b1f9471fbf0, const void *arg_0x2b1f94725020, size_t arg_0x2b1f947252c8);

extern void *memset(void *arg_0x2b1f94724980, int arg_0x2b1f94724be8, size_t arg_0x2b1f94723020);
#line 61
extern void *memset(void *arg_0x2b1f9473db10, int arg_0x2b1f9473dd78, size_t arg_0x2b1f9473c060);
...
struct _reent {
  ...
  void (*__cleanup)(struct _reent *arg_0x2b1f9477e290);
  ...
  void (**_sig_func)(int arg_0x2b1f94783300);
...
# 47 "../../platforms/telosb/OrinocoPlatform.h"
enum __nesc_unnamed4266 {
  ORINOCO_DFLT_CONGESTION_WIN_MIN = 15, 
  ORINOCO_DFLT_CONGESTION_WIN_MAX = 32, 
  ORINOCO_ACK_WAITING_TIME = 8, 
  ORINOCO_DATA_WAITING_TIME = 8
};
...
# 59 "../../lib/net/orinoco/MulticastCommands.h"
#line 48
typedef enum __nesc_unnamed4276 {
  ORINOCO_MULTICAST_COMMAND_SAMPLE_FAST = 0x60, 
  ORINOCO_MULTICAST_COMMAND_SAMPLE_NORM = 0x40, 
  ORINOCO_MULTICAST_COMMAND_SAMPLE_SLOW = 0x20, 


  ORINOCO_MULTICAST_COMMAND_LED1 = 0x10, 
  ORINOCO_MULTICAST_COMMAND_LED2 = 0x08, 
  ORINOCO_MULTICAST_COMMAND_LED3 = 0x04, 

  ORINOCO_MULTICAST_COMMAND_POLLCMD = 0x02
} orinoco_multicast_commands_t;
# 13 "../../lib/net/orinoco/RadioTest.h"
#line 6
typedef nx_struct CloudCoverHeader {

  nx_uint16_t header_ZLsb;
  nx_uint8_t header_ZMsbAM;
  nx_uint8_t header_VA;

  nx_uint8_t data[1];
} __attribute__((packed)) CloudCoverHeader;
...
#line 16
typedef nx_struct CloudCoverMAX {
  ...
  nx_uint8_t length;
  nx_uint8_t data[60];
} __attribute__((packed)) CloudCoverMAX;



enum __nesc_unnamed4277 {
  AM_CLOUDCOVERHEADER = 6, 
  MAX_BIT = 8, 
  MAX_CODE = 9, 
  NUMBER_OF_VALUES_FACTOR = 12, 
  DEFAULT_VALUE = 4, 
  ARRAY_MAX = 168, 
  CC_HEADER_MIN_SIZE = 4, 
  ENCODED_MAX_SIZE = 30
};
...
enum __nesc_unnamed4278 {
  ...
  HEADER_VALUES_OFFSET = 15, 
  HEADER_MODE_OFFSET = 64, 
  HEADER_RESOLUTION_OFFSET = 128, 
  HEADER_TIME_MSB_OFFSET = 16, 
  HEADER_TIME_MSB = 63, 
  HEADER_TIME_LSB_OFFSET = 0
};
...
# 14 "../../lib/net/orinoco/OrinocoBeaconMsg.h"
#line 11
...
typedef nx_struct orinoco_routing_t {
  nx_uint16_t version;
  nx_uint8_t cmd;
  nx_uint8_t bloom[BLOOM_BYTES];
} __attribute__((packed)) orinoco_routing_t;
...
typedef nx_struct OrinocoCommandAckMsg {
  ...
  nx_uint16_t version;
  nx_uint8_t result;
} __attribute__((packed)) OrinocoCommandAckMsg;
...
typedef TMilli TestC__LocalTime__precision_tag;
typedef TMilli TestC__BootTimer__precision_tag;
typedef CloudCoverMAX TestC__Value__t;
...
typedef TMilli OrinocoRoutingP__Clock__precision_tag;
typedef CloudCoverMAX RadioTestC__Update__t;
typedef TMilli RadioTestC__LocalTimeMilli__precision_tag;
typedef CloudCoverMAX RadioTestC__Value__t;
...
enum /*OrinocoTrafficStatisticsC.Job*/EAJobC__0____nesc_unnamed4332 {
  EAJobC__0__JOB_ID = 0U
};
typedef TMilli EASchedulerP__DispatchTimer__precision_tag;
enum /*OrinocoStatsReportingJobC.Job*/EAJobC__1____nesc_unnamed4333 {
...
enum /*OrinocoDebugReportingJobC.Job*/EAJobC__2____nesc_unnamed4334 {
...
TestC__OrinocoDebugReporting__receive(
#line 71
message_t * msg, 
void * payload, 
...
# 48 "../../interfaces/OrinocoRoutingClient.nc"
static void TestC__OrinocoRouting__noMorePacketNotification(void );
#line 45
static void TestC__OrinocoRouting__newCommandNotification(uint8_t cmd, uint16_t identifier);
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
static 
#line 74
message_t * 
...
TestC__RadioReceive__receive(
# 74 "TestC.nc"
collection_id_t arg_0x2b1f94f288d0, 
...
TestC__OrinocoStatsReporting__receive(
#line 71
message_t * msg, 
void * payload, 
...
static void TestC__BootTimer__fired(void );
# 69 "/opt/tinyos-2.1.2/tos/lib/net/DisseminationValue.nc"
static void TestC__Value__changed(void );
# 83 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
...
#line 42
static error_t OrinocoQueueP__RootControl__unsetRoot(void );
...
# 54 "../../lib/net/orinoco/QueueStatus.nc"
...
collection_id_t arg_0x2b1f94f85270, 
...
uint8_t len);
#line 106
static uint8_t OrinocoQueueP__Packet__maxPayloadLength(void );
#line 94
static void OrinocoQueueP__Packet__setPayloadLength(
#line 90
message_t * msg, 
...
uint8_t len);
# 66 "../../interfaces/QueueSend.nc"
static error_t OrinocoQueueP__Send__send(
# 51 "../../lib/net/orinoco/OrinocoQueueP.nc"
collection_id_t arg_0x2b1f94f88b50, 
# 58 "../../interfaces/QueueSend.nc"
message_t * msg, 
...
uint8_t len);
#line 78
static uint8_t OrinocoQueueP__Send__maxPayloadLength(
# 51 "../../lib/net/orinoco/OrinocoQueueP.nc"
collection_id_t arg_0x2b1f94f88b50);
# 62 "/opt/tinyos-2.1.2/tos/interfaces/Init.nc"
...
# 45 "../../interfaces/OrinocoRoutingStateInternal.nc"
static uint16_t OrinocoQueueP__OrinocoRoutingStateInternal__getPacketRoutingInformationVersion(message_t *msg);


static void OrinocoQueueP__OrinocoRoutingStateInternal__setRoutingInformationVersion(uint16_t version);
# 75 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
...
# 60 "../../lib/net/orinoco/QueueStatus.nc"
...
#line 94
static void OrinocoRadioP__Packet__setPayloadLength(
#line 90
message_t * msg, 
...
error_t error);
# 5 "../../lib/net/orinoco/OrinocoDataInterface.nc"
static error_t OrinocoRadioP__OrinocoDI__appendDataVer(void );




static void *OrinocoRadioP__OrinocoDI__getBeaconPayload(uint8_t len);
#line 4
static void *OrinocoRadioP__OrinocoDI__getDataPayload(void );




static error_t OrinocoRadioP__OrinocoDI__appendBeacon(uint8_t laenge);
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
static 
#line 74
message_t * 
...
# 54 "/opt/tinyos-2.1.2/tos/chips/cc2420/CC2420ActiveMessageP.nc"
am_id_t arg_0x2b1f960d9d60, 
# 73 "/opt/tinyos-2.1.2/tos/chips/cc2420/interfaces/RadioBackoff.nc"
bool ccaOn);
...
#line 94
static void OrinocoPacketDelayLayerP__Packet__setPayloadLength(
#line 90
message_t * msg, 
...
uint8_t len);
# 44 "../../interfaces/PacketDelay.nc"
static void OrinocoPacketDelayLayerP__PacketDelayMilli__init(message_t *msg);
# 62 "/opt/tinyos-2.1.2/tos/interfaces/Init.nc"
static error_t OrinocoConfigP__Init__init(void );
# 90 "../../interfaces/OrinocoConfig.nc"
...
#line 81
static error_t OrinocoConfigP__OrinocoConfig__setMinQueueSize(uint8_t m);
#line 60
...
# 60 "/opt/tinyos-2.1.2/tos/interfaces/Boot.nc"
static void OrinocoRoutingP__Boot__booted(void );
# 62 "/opt/tinyos-2.1.2/tos/interfaces/Init.nc"
static error_t OrinocoRoutingP__Init__init(void );
# 51 "../../interfaces/OrinocoRoutingClient.nc"
static void OrinocoRoutingP__OrinocoRoutingClient__confirmCommandExecution(uint8_t cmd, uint16_t identifier, error_t status);
# 48 "../../interfaces/OrinocoRoutingInternal.nc"
static const orinoco_routing_t *OrinocoRoutingP__OrinocoRoutingInternal__getCurrentBloomFilter(void );
#line 45
static void OrinocoRoutingP__OrinocoRoutingInternal__updateBloomFilter(const orinoco_routing_t *newFilter);





static uint16_t OrinocoRoutingP__OrinocoRoutingInternal__getRoutingVersionNumber(void );
# 75 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
static void RadioTestC__changedTask__runTask(void );
# 8 "../../lib/net/orinoco/OrinocoDataInterface.nc"
static void RadioTestC__Orinoco__receivedBeacon(void *data, uint8_t len);
#line 3
static void RadioTestC__Orinoco__receivedData(void *data, uint8_t len);
#line 2
static void RadioTestC__Orinoco__aboutToSendData(void );




static void RadioTestC__Orinoco__aboutToSendBeacon(void );
# 2 "../../lib/net/orinoco/OrinocoDataSizeInterface.nc"
static uint8_t RadioTestC__VerSize__getVersionSize(void );
# 55 "/opt/tinyos-2.1.2/tos/lib/net/DisseminationValue.nc"
static const RadioTestC__Value__t *RadioTestC__Value__get(void );
...
static void RadioTestC__Value__set(const RadioTestC__Value__t *arg_0x2b1f94f09e80);
# 75 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
static void RadioTestC__decodingTask__runTask(void );
# 4 "../../lib/net/orinoco/Decoder.nc"
static void DecodeC__Decoder__decode(nx_uint8_t *data, uint8_t n, uint8_t output[], uint8_t *arrSize, uint8_t mode);
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
...
# 95 "/opt/tinyos-2.1.2/tos/chips/cc2420/interfaces/RadioBackoff.nc"
static void OrinocoCC2420ModificationsP__RadioBackoff__requestCca(
# 42 "../../chips/cc2420/OrinocoCC2420ModificationsP.nc"
am_id_t arg_0x2b1f9673d020, 
# 95 "/opt/tinyos-2.1.2/tos/chips/cc2420/interfaces/RadioBackoff.nc"
message_t * msg);
#line 81
static void OrinocoCC2420ModificationsP__RadioBackoff__requestInitialBackoff(
# 42 "../../chips/cc2420/OrinocoCC2420ModificationsP.nc"
am_id_t arg_0x2b1f9673d020, 
...
static void OrinocoCC2420ModificationsP__RadioBackoff__requestCongestionBackoff(
# 42 "../../chips/cc2420/OrinocoCC2420ModificationsP.nc"
am_id_t arg_0x2b1f9673d020, 
...
# 56 "../../lib/net/orinoco/OrinocoTrafficUpdates.nc"
...
#line 45
static void OrinocoTrafficStatisticsP__Updates__updatePktCreationIntvl(void );
...
# 42 "/opt/tinyos-2.1.2/tos/lib/net/RootControl.nc"
static error_t TestC__RootControl__unsetRoot(void );
# 43 "/opt/tinyos-2.1.2/tos/lib/net/CollectionPacket.nc"
static am_addr_t TestC__CollectionPacket__getOrigin(message_t *msg);
# 65 "/opt/tinyos-2.1.2/tos/interfaces/Packet.nc"
static void TestC__Packet__clear(
#line 62
message_t * msg);
#line 126
static 
...
uint8_t len);
# 61 "/opt/tinyos-2.1.2/tos/lib/timer/LocalTime.nc"
static uint32_t TestC__LocalTime__get(void );
# 104 "/opt/tinyos-2.1.2/tos/interfaces/SplitControl.nc"
static error_t TestC__RadioControl__start(void );
# 66 "../../interfaces/QueueSend.nc"
static error_t TestC__Send__send(
# 70 "TestC.nc"
collection_id_t arg_0x2b1f94efe198, 
# 58 "../../interfaces/QueueSend.nc"
message_t * msg, 
...
uint8_t len);
# 51 "../../interfaces/OrinocoRoutingClient.nc"
static void TestC__OrinocoRouting__confirmCommandExecution(uint8_t cmd, uint16_t identifier, error_t status);
# 46 "/opt/tinyos-2.1.2/tos/interfaces/Random.nc"
static uint32_t TestC__Random__rand32(void );
# 72 "/opt/tinyos-2.1.2/tos/interfaces/Leds.nc"
static void TestC__Leds__led1On(void );
...
#line 89
static void TestC__Leds__led2On(void );
# 73 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void TestC__BootTimer__startOneShot(uint32_t dt);
# 95 "/opt/tinyos-2.1.2/tos/interfaces/StdControl.nc"
static error_t TestC__ForwardingControl__start(void );
# 55 "/opt/tinyos-2.1.2/tos/lib/net/DisseminationValue.nc"
static const TestC__Value__t *TestC__Value__get(void );
...
static void TestC__Value__set(const TestC__Value__t *arg_0x2b1f94f09e80);
# 73 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void TestC__Timer__startOneShot(uint32_t dt);
# 44 "../../interfaces/OrinocoConfig.nc"
static void TestC__OrinocoConfig__setWakeUpInterval(uint16_t Ts);
#line 81
static error_t TestC__OrinocoConfig__setMinQueueSize(uint8_t m);
# 92 "TestC.nc"
message_t TestC__myMsg;
uint16_t TestC__cnt = 0;

uint32_t TestC__delay = 61440UL;
CloudCoverMAX TestC__defPackage;

static inline void TestC__Boot__booted(void );
#line 119
static inline void TestC__Value__changed(void );
...
static message_t *
TestC__RadioReceive__receive(collection_id_t type, message_t *msg, void *payload, uint8_t len);
...
static inline void TestC__BootTimer__fired(void );
...
#line 170
static inline void TestC__restartTimer(uint32_t value);




static inline void TestC__OrinocoRouting__newCommandNotification(uint8_t cmd, uint16_t identifier);
#line 221
static inline void TestC__OrinocoRouting__noMorePacketNotification(void );
...
static inline message_t *TestC__OrinocoStatsReporting__receive(message_t *msg, void *payload, uint8_t len);





static inline message_t *TestC__OrinocoDebugReporting__receive(message_t *msg, void *payload, uint8_t len);
# 75 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
...
uint8_t len);
# 44 "../../interfaces/PacketDelay.nc"
static void OrinocoQueueP__PacketDelayMilli__init(message_t *msg);
# 73 "/opt/tinyos-2.1.2/tos/interfaces/Queue.nc"
static 
#line 71
...
#line 94
static void OrinocoQueueP__SubPacket__setPayloadLength(
#line 90
message_t * msg, 
...
collection_id_t arg_0x2b1f94f879d8, 
# 71 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
message_t * msg, 
void * payload, 
...
#line 45
static void OrinocoQueueP__TrafficUpdates__updatePktCreationIntvl(void );
# 51 "/opt/tinyos-2.1.2/tos/interfaces/Cache.nc"
...
# 107 "../../lib/net/orinoco/OrinocoQueueP.nc"
enum OrinocoQueueP____nesc_unnamed4337 {
#line 107
  OrinocoQueueP__selfReceiveTask = 0U
};
#line 107
typedef int OrinocoQueueP____nesc_sillytask_selfReceiveTask[OrinocoQueueP__selfReceiveTask];
#line 160
enum OrinocoQueueP____nesc_unnamed4338 {
#line 160
  OrinocoQueueP__sendTask = 1U
};
#line 160
...
uint8_t OrinocoQueueP__seqno_ = 0;
uint16_t OrinocoQueueP__routingVersion_ = 0;
...
#line 218
static inline void OrinocoQueueP__OrinocoRoutingStateInternal__setRoutingInformationVersion(uint16_t ver);



static inline uint16_t OrinocoQueueP__OrinocoRoutingStateInternal__getPacketRoutingInformationVersion(message_t *msg);
...
#line 256
static inline error_t OrinocoQueueP__RootControl__unsetRoot(void );
...
#line 276
static error_t OrinocoQueueP__Send__send(collection_id_t type, message_t *msg, uint8_t len);
#line 384
static inline uint8_t OrinocoQueueP__Send__maxPayloadLength(collection_id_t type);
#line 410
...
static inline void OrinocoQueueP__Packet__setPayloadLength(message_t *msg, uint8_t len);



static inline uint8_t OrinocoQueueP__Packet__maxPayloadLength(void );
...
# 61 "/opt/tinyos-2.1.2/tos/lib/timer/LocalTime.nc"
static uint32_t OrinocoRadioP__LocalTime__get(void );
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
...
# 60 "../../interfaces/OrinocoConfig.nc"
...
#line 94
static void OrinocoRadioP__SubPacket__setPayloadLength(
#line 90
message_t * msg, 
...
uint8_t len);
#line 123
static uint8_t OrinocoRadioP__BeaconSubSend__maxPayloadLength(void );
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
static 
#line 74
message_t * 
...
uint8_t len);
# 2 "../../lib/net/orinoco/OrinocoDataSizeInterface.nc"
static uint8_t OrinocoRadioP__VerSize__getVersionSize(void );
# 8 "../../lib/net/orinoco/OrinocoDataInterface.nc"
static void OrinocoRadioP__OrinocoDI__receivedBeacon(void *data, uint8_t len);
#line 3
static void OrinocoRadioP__OrinocoDI__receivedData(void *data, uint8_t len);
#line 2
static void OrinocoRadioP__OrinocoDI__aboutToSendData(void );




static void OrinocoRadioP__OrinocoDI__aboutToSendBeacon(void );
# 45 "../../interfaces/OrinocoRoutingStateInternal.nc"
static uint16_t OrinocoRadioP__RoutingState__getPacketRoutingInformationVersion(message_t *msg);


static void OrinocoRadioP__RoutingState__setRoutingInformationVersion(uint16_t version);
# 45 "../../lib/net/orinoco/OrinocoPathCost.nc"
...
# 48 "../../interfaces/OrinocoRoutingInternal.nc"
static const orinoco_routing_t *OrinocoRadioP__Routing__getCurrentBloomFilter(void );
#line 45
static void OrinocoRadioP__Routing__updateBloomFilter(const orinoco_routing_t *newFilter);





static uint16_t OrinocoRadioP__Routing__getRoutingVersionNumber(void );
# 387 "../../lib/net/orinoco/OrinocoRadioP.nc"
enum OrinocoRadioP____nesc_unnamed4339 {
#line 387
  OrinocoRadioP__transition = 2U
};
#line 387
...
am_addr_t OrinocoRadioP__lastBeaconDestination_ = AM_BROADCAST_ADDR;
uint16_t OrinocoRadioP__rxRouteVersion_ = 0;


uint32_t OrinocoRadioP__shortBcnTxCount_ = 0;
#line 137
uint32_t OrinocoRadioP__longBcnTxCount_ = 0;
#line 137
uint32_t OrinocoRadioP__errBcnTxCount_ = 0;
...
uint8_t OrinocoRadioP__extBeaconSize;
uint8_t OrinocoRadioP__energyCounter = 0;
uint32_t OrinocoRadioP__energy = 0;

static inline error_t OrinocoRadioP__OrinocoDI__appendBeacon(uint8_t laenge);
#line 165
static inline error_t OrinocoRadioP__OrinocoDI__appendDataVer(void );
...
static inline void *OrinocoRadioP__OrinocoDI__getDataPayload(void );
#line 193
...
enum OrinocoRadioP____nesc_unnamed4340 {
  OrinocoRadioP__OFF, 
...
#line 765
static message_t *OrinocoRadioP__BeaconSubReceive__receive(message_t *msg, void *payload, uint8_t len);
#line 913
...
#line 1008
static void OrinocoRadioP__BeaconSubSend__sendDone(message_t *msg, error_t error);
#line 1040
...
static inline void OrinocoRadioP__Packet__setPayloadLength(message_t *msg, uint8_t len);
...
enum OrinocoForwardLayerP____nesc_unnamed4381 {
#line 70
  OrinocoForwardLayerP__doneTask = 15U
};
#line 70
typedef int OrinocoForwardLayerP____nesc_sillytask_doneTask[OrinocoForwardLayerP__doneTask];
#line 52
enum OrinocoForwardLayerP____nesc_unnamed4382 {
...
#line 94
static void OrinocoPacketDelayLayerP__SubPacket__setPayloadLength(
#line 90
message_t * msg, 
...
# 55 "../../lib/net/orinoco/OrinocoPacketDelayLayerP.nc"
...
#line 115
static void OrinocoPacketDelayLayerP__SubAMSend__sendDone(message_t *msg, error_t error);
#line 129
...
static inline void OrinocoPacketDelayLayerP__Packet__setPayloadLength(message_t *msg, uint8_t len);
...
static inline void OrinocoPacketDelayLayerP__PacketDelayMilli__init(message_t *msg);
...
static inline error_t OrinocoConfigP__OrinocoConfig__setMinQueueSize(uint8_t m);
...
OrinocoRoutingP__Packet__getPayload(
#line 121
message_t * msg, 
...
uint8_t len);
# 50 "/opt/tinyos-2.1.2/tos/interfaces/ActiveMessageAddress.nc"
static am_addr_t OrinocoRoutingP__AMA__amAddress(void );
# 66 "../../interfaces/QueueSend.nc"
static error_t OrinocoRoutingP__Send__send(
# 51 "../../lib/net/orinoco/OrinocoRoutingP.nc"
collection_id_t arg_0x2b1f9623b9d8, 
# 58 "../../interfaces/QueueSend.nc"
message_t * msg, 
...
uint8_t len);
# 48 "../../interfaces/OrinocoRoutingClient.nc"
static void OrinocoRoutingP__OrinocoRoutingClient__noMorePacketNotification(void );
#line 45
static void OrinocoRoutingP__OrinocoRoutingClient__newCommandNotification(uint8_t cmd, uint16_t identifier);
# 61 "/opt/tinyos-2.1.2/tos/lib/timer/LocalTime.nc"
static uint32_t OrinocoRoutingP__Clock__get(void );
# 65 "../../lib/net/orinoco/OrinocoRoutingP.nc"
message_t OrinocoRoutingP__myMsg;

bool OrinocoRoutingP__packetWaiting_ = FALSE;

orinoco_routing_t OrinocoRoutingP__curRouting_;
orinoco_bloom_pointers_t OrinocoRoutingP__bp_;
am_addr_t OrinocoRoutingP__localId_;




static inline uint8_t OrinocoRoutingP__calcHash(am_addr_t address, uint8_t salt);
#line 95
static inline void OrinocoRoutingP__updateHashes(void );
#line 112
static inline bool OrinocoRoutingP__checkForPresenceInFilter(void );
#line 126
static inline void OrinocoRoutingP__sendConfirmation(uint8_t cmd, uint16_t version, error_t status);
#line 157
static inline void OrinocoRoutingP__clearBloomFilter(void );
#line 190
static inline error_t OrinocoRoutingP__Init__init(void );
#line 205
static inline void OrinocoRoutingP__OrinocoRoutingClient__confirmCommandExecution(uint8_t cmd, uint16_t version, error_t status);
#line 224
static inline void OrinocoRoutingP__OrinocoRoutingInternal__updateBloomFilter(const orinoco_routing_t *route);
#line 285
static inline const orinoco_routing_t *OrinocoRoutingP__OrinocoRoutingInternal__getCurrentBloomFilter(void );



static inline uint16_t OrinocoRoutingP__OrinocoRoutingInternal__getRoutingVersionNumber(void );
#line 336
static inline void OrinocoRoutingP__Boot__booted(void );
# 67 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
static error_t RadioTestC__changedTask__postTask(void );
# 5 "../../lib/net/orinoco/OrinocoDataInterface.nc"
static error_t RadioTestC__Orinoco__appendDataVer(void );




static void *RadioTestC__Orinoco__getBeaconPayload(uint8_t len);
#line 4
static void *RadioTestC__Orinoco__getDataPayload(void );




static error_t RadioTestC__Orinoco__appendBeacon(uint8_t laenge);
# 4 "../../lib/net/orinoco/Decoder.nc"
static void RadioTestC__Decoder__decode(nx_uint8_t *data, uint8_t n, uint8_t output[], uint8_t *arrSize, uint8_t mode);
# 61 "/opt/tinyos-2.1.2/tos/lib/timer/LocalTime.nc"
static uint32_t RadioTestC__LocalTimeMilli__get(void );
# 69 "/opt/tinyos-2.1.2/tos/lib/net/DisseminationValue.nc"
static void RadioTestC__Value__changed(void );
# 67 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
static error_t RadioTestC__decodingTask__postTask(void );
# 56 "../../lib/net/orinoco/RadioTestC.nc"
enum RadioTestC____nesc_unnamed4383 {
#line 56
  RadioTestC__decodingTask = 16U
};
#line 56
typedef int RadioTestC____nesc_sillytask_decodingTask[RadioTestC__decodingTask];
#line 105
enum RadioTestC____nesc_unnamed4384 {
#line 105
  RadioTestC__changedTask = 17U
};
#line 105
typedef int RadioTestC____nesc_sillytask_changedTask[RadioTestC__changedTask];
#line 23
uint8_t RadioTestC__isNew = 0;
uint8_t RadioTestC__ccPackageLength;
uint32_t RadioTestC__pStartTime;
uint32_t RadioTestC__tsTime;


CloudCoverMAX RadioTestC__paket;
#line 45
static inline void RadioTestC__parseCloudCoverHeader(uint8_t *version, uint8_t *size, uint8_t *mode, uint32_t *timeStamp, uint8_t *resolution);
...
static inline void RadioTestC__decodingTask__runTask(void );
#line 95
static inline uint8_t RadioTestC__VerSize__getVersionSize(void );
...
static inline void RadioTestC__changedTask__runTask(void );
#line 133
static inline const CloudCoverMAX *RadioTestC__Value__get(void );




static inline void RadioTestC__Value__set(const CloudCoverMAX *val);
...
static inline void RadioTestC__Orinoco__aboutToSendData(void );
#line 173
static inline void RadioTestC__Orinoco__receivedData(void *data, uint8_t len);
#line 207
static inline void RadioTestC__Orinoco__aboutToSendBeacon(void );
#line 249
static inline void RadioTestC__Orinoco__receivedBeacon(void *data, uint8_t len);
# 42 "../../lib/net/orinoco/DecodeC.nc"
static uint8_t DecodeC__getPosBitstreamR(nx_uint8_t *stream, uint8_t size, uint8_t *pos, uint8_t offset);
#line 250
static inline void DecodeC__decode0nextValue(nx_uint8_t *data, uint8_t *value, uint8_t *arrSize, uint8_t *posi);
#line 282
static inline void DecodeC__decode1nextValue(nx_uint8_t *data, uint8_t *value, uint8_t *arrSize, uint8_t *posi);
#line 327
static inline void DecodeC__Decoder__decode(nx_uint8_t *data, uint8_t n, uint8_t output[], uint8_t *arrSize, uint8_t mode);
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
...
enum /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP__0____nesc_unnamed4385 {
#line 126
...
#line 169
enum /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP__0____nesc_unnamed4386 {
#line 169
...
#line 57
#line 55
typedef struct /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP__0____nesc_unnamed4387 {
  message_t * msg;
...
#line 111
typedef enum SerialP____nesc_unnamed4395 {
...
#line 66
#line 62
typedef enum /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0____nesc_unnamed4402 {
...
#line 74
typedef struct /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0____nesc_unnamed4404 {
  uint8_t which : 1;
...
#line 56
typedef struct HdlcTranslateC____nesc_unnamed4405 {
...
# 49 "/opt/tinyos-2.1.2/tos/system/FcfsResourceQueueC.nc"
enum /*Msp430UsartShare1P.ArbiterC.Queue*/FcfsResourceQueueC__2____nesc_unnamed4406 {
#line 49
...
# 75 "/opt/tinyos-2.1.2/tos/system/ArbiterP.nc"
enum /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__1____nesc_unnamed4407 {
#line 75
...
#line 67
enum /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__1____nesc_unnamed4408 {
#line 67
  ArbiterP__1__RES_CONTROLLED, ArbiterP__1__RES_GRANTING, ArbiterP__1__RES_IMM_GRANTING, ArbiterP__1__RES_BUSY
};
#line 68
enum /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__1____nesc_unnamed4409 {
#line 68
  ArbiterP__1__default_owner_id = 1U
};
#line 69
enum /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__1____nesc_unnamed4410 {
#line 69
...
enum PrintfP____nesc_unnamed4411 {
#line 114
...
#line 101
enum PrintfP____nesc_unnamed4412 {
  PrintfP__S_STARTED, 
  PrintfP__S_FLUSHING
};
...
# 66 "/opt/tinyos-2.1.2/tos/chips/cc2420/interfaces/RadioBackoff.nc"
static void OrinocoCC2420ModificationsP__RadioBackoff__setCongestionBackoff(
# 42 "../../chips/cc2420/OrinocoCC2420ModificationsP.nc"
am_id_t arg_0x2b1f9673d020, 
# 66 "/opt/tinyos-2.1.2/tos/chips/cc2420/interfaces/RadioBackoff.nc"
uint16_t backoffTime);
#line 60
static void OrinocoCC2420ModificationsP__RadioBackoff__setInitialBackoff(
# 42 "../../chips/cc2420/OrinocoCC2420ModificationsP.nc"
am_id_t arg_0x2b1f9673d020, 
# 60 "/opt/tinyos-2.1.2/tos/chips/cc2420/interfaces/RadioBackoff.nc"
uint16_t backoffTime);
#line 73
static void OrinocoCC2420ModificationsP__RadioBackoff__setCca(
# 42 "../../chips/cc2420/OrinocoCC2420ModificationsP.nc"
am_id_t arg_0x2b1f9673d020, 
# 73 "/opt/tinyos-2.1.2/tos/chips/cc2420/interfaces/RadioBackoff.nc"
bool ccaOn);
# 47 "../../chips/cc2420/OrinocoCC2420ModificationsP.nc"
static inline void OrinocoCC2420ModificationsP__RadioBackoff__requestInitialBackoff(am_id_t amId, message_t *msg);



static inline void OrinocoCC2420ModificationsP__RadioBackoff__requestCongestionBackoff(am_id_t amId, message_t *msg);



static inline void OrinocoCC2420ModificationsP__RadioBackoff__requestCca(am_id_t amId, message_t *msg);
# 43 "/opt/tinyos-2.1.2/tos/lib/net/RootControl.nc"
...
/*OrinocoP.SendQueue*/QueueC__0__queue_t  /*OrinocoP.SendQueue*/QueueC__0__queue[30];
...
#line 97
static error_t /*OrinocoP.SendQueue*/QueueC__0__Queue__enqueue(/*OrinocoP.SendQueue*/QueueC__0__queue_t newVal);
...
/*OrinocoP.MsgPool.PoolP*/PoolP__0__pool_t * /*OrinocoP.MsgPool.PoolP*/PoolP__0__queue[30];
/*OrinocoP.MsgPool.PoolP*/PoolP__0__pool_t /*OrinocoP.MsgPool.PoolP*/PoolP__0__pool[30];

static inline error_t /*OrinocoP.MsgPool.PoolP*/PoolP__0__Init__init(void );
#line 88
static /*OrinocoP.MsgPool.PoolP*/PoolP__0__pool_t */*OrinocoP.MsgPool.PoolP*/PoolP__0__Pool__get(void );
#line 103
...
/*OrinocoP.PacketHistory*/OrinocoCacheC__0__cache_t /*OrinocoP.PacketHistory*/OrinocoCacheC__0__cache[40];
...
static inline void OrinocoTrafficStatisticsP__Updates__updatePktCreationIntvl(void );
...
uint8_t arg_0x2b1f96810608);
#line 104
enum EASchedulerP____nesc_unnamed4415 {
#line 104
  EASchedulerP__dispatch = 28U
};
#line 104
typedef int EASchedulerP____nesc_sillytask_dispatch[EASchedulerP__dispatch];
#line 67
enum EASchedulerP____nesc_unnamed4416 {
...
enum EAEnergyManagerP____nesc_unnamed4417 {
...
# 39 "/opt/tinyos-2.1.2/tos/chips/msp430/timer/Msp430TimerEvent.nc"
inline static void /*Msp430TimerC.Msp430TimerA*/Msp430TimerP__0__Event__fired(uint8_t arg_0x2b1f94d8edc8){
#line 39
  switch (arg_0x2b1f94d8edc8) {
#line 39
    case 0:
#line 39
...
#line 39
    default:
#line 39
      /*Msp430TimerC.Msp430TimerA*/Msp430TimerP__0__Event__default__fired(arg_0x2b1f94d8edc8);
#line 39
      break;
#line 39
    }
...
#line 66
# 264 "/opt/tinyos-2.1.2/tos/chips/cc2420/CC2420ActiveMessageP.nc"
static inline void CC2420ActiveMessageP__RadioBackoff__setCongestionBackoff(am_id_t amId, uint16_t backoffTime)
#line 264
{
...
# 66 "/opt/tinyos-2.1.2/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void OrinocoCC2420ModificationsP__RadioBackoff__setCongestionBackoff(am_id_t arg_0x2b1f9673d020, uint16_t backoffTime){
#line 66
  CC2420ActiveMessageP__RadioBackoff__setCongestionBackoff(arg_0x2b1f9673d020, backoffTime);
#line 66
}
#line 66
# 51 "../../chips/cc2420/OrinocoCC2420ModificationsP.nc"
static inline void OrinocoCC2420ModificationsP__RadioBackoff__requestCongestionBackoff(am_id_t amId, message_t *msg)
#line 51
{
  OrinocoCC2420ModificationsP__RadioBackoff__setCongestionBackoff(amId, 0);
}

# 88 "/opt/tinyos-2.1.2/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestCongestionBackoff(am_id_t arg_0x2b1f960d9d60, message_t * msg){
#line 88
  OrinocoCC2420ModificationsP__RadioBackoff__requestCongestionBackoff(arg_0x2b1f960d9d60, msg);
#line 88
}
#line 88
...
# 128 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static bool /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__isOwner(uint8_t arg_0x2b1f95885be8){
#line 128
  unsigned char __nesc_result;
#line 128

#line 128
  switch (arg_0x2b1f95885be8) {
#line 128
...
#line 128
    default:
#line 128
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__isOwner(arg_0x2b1f95885be8);
#line 128
      break;
#line 128
    }
...
# 39 "/opt/tinyos-2.1.2/tos/chips/msp430/usart/Msp430SpiConfigure.nc"
inline static msp430_spi_union_config_t */*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Msp430SpiConfigure__getConfig(uint8_t arg_0x2b1f95884e18){
#line 39
  union __nesc_unnamed4302 *__nesc_result;
#line 39

#line 39
    __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Msp430SpiConfigure__default__getConfig(arg_0x2b1f95884e18);
#line 39
...
# 59 "/opt/tinyos-2.1.2/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__configure(uint8_t arg_0x2b1f95a749b8){
#line 59
  switch (arg_0x2b1f95a749b8) {
#line 59
...
#line 59
    default:
#line 59
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__default__configure(arg_0x2b1f95a749b8);
#line 59
      break;
#line 59
    }
...
# 61 "/opt/tinyos-2.1.2/tos/interfaces/ResourceRequested.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceRequested__immediateRequested(uint8_t arg_0x2b1f95a777e8){
#line 61
    /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceRequested__default__immediateRequested(arg_0x2b1f95a777e8);
#line 61
}
#line 61
...
# 97 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__immediateRequest(uint8_t arg_0x2b1f95885be8){
#line 97
  unsigned char __nesc_result;
#line 97
...
#line 97
    default:
#line 97
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__immediateRequest(arg_0x2b1f95885be8);
#line 97
      break;
#line 97
    }
...
# 53 "/opt/tinyos-2.1.2/tos/interfaces/ResourceRequested.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceRequested__requested(uint8_t arg_0x2b1f95a777e8){
#line 53
    /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceRequested__default__requested(arg_0x2b1f95a777e8);
#line 53
}
#line 53
...
# 88 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__request(uint8_t arg_0x2b1f95885be8){
#line 88
  unsigned char __nesc_result;
#line 88
...
#line 88
    default:
#line 88
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__request(arg_0x2b1f95885be8);
#line 88
      break;
#line 88
    }
...
# 65 "/opt/tinyos-2.1.2/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__unconfigure(uint8_t arg_0x2b1f95a749b8){
#line 65
  switch (arg_0x2b1f95a749b8) {
#line 65
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
...
#line 65
    default:
#line 65
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__default__unconfigure(arg_0x2b1f95a749b8);
#line 65
      break;
#line 65
    }
...
# 120 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__release(uint8_t arg_0x2b1f95885be8){
#line 120
  unsigned char __nesc_result;
#line 120
...
#line 120
    default:
#line 120
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__release(arg_0x2b1f95885be8);
#line 120
      break;
#line 120
    }
...
#line 47
# 216 "../../lib/net/orinoco/OrinocoTrafficStatisticsP.nc"
static inline void OrinocoTrafficStatisticsP__PktRateJob__run(void )
#line 216
{
...
#line 78
  __nesc_result = TestC__OrinocoStatsReporting__receive(msg, payload, len);
#line 78
...
#line 78
# 122 "../../lib/net/orinoco/OrinocoTrafficStatisticsP.nc"
static inline uint8_t OrinocoTrafficStatisticsP__Stats__getRxBurst(void )
#line 122
{
...
#line 52
# 107 "../../lib/net/orinoco/OrinocoTrafficStatisticsP.nc"
static inline uint8_t OrinocoTrafficStatisticsP__Stats__getTxBurst(void )
#line 107
{
...
#line 50
# 159 "../../lib/net/orinoco/OrinocoTrafficStatisticsP.nc"
static inline uint32_t OrinocoTrafficStatisticsP__Stats__getForwardDelay(void )
#line 159
{
...
#line 48
# 79 "../../lib/net/orinoco/OrinocoTrafficStatisticsP.nc"
static inline uint16_t OrinocoTrafficStatisticsP__Stats__getPktCreationIntvl(void )
#line 79
{
...
#line 65
# 136 "../../lib/net/orinoco/OrinocoPacketDelayLayerP.nc"
static inline void OrinocoPacketDelayLayerP__Packet__clear(message_t *msg)
#line 136
{
...
#line 65
# 1192 "../../lib/net/orinoco/OrinocoRadioP.nc"
static inline void OrinocoRadioP__Packet__clear(message_t *msg)
#line 1192
{
...
#line 65
# 513 "../../lib/net/orinoco/OrinocoQueueP.nc"
static inline void OrinocoQueueP__Packet__clear(message_t *msg)
#line 513
{
...
# 61 "/opt/tinyos-2.1.2/tos/lib/timer/LocalTime.nc"
inline static uint32_t TestC__LocalTime__get(void ){
#line 61
  unsigned long __nesc_result;
#line 61
...
#line 242
  ...
  TOS_NODE_ID, 
  TestC__LocalTime__get(), __nesc_ntoh_uint16(
...
#line 78
  __nesc_result = TestC__OrinocoDebugReporting__receive(msg, payload, len);
#line 78
...
#line 78
# 612 "../../lib/net/orinoco/OrinocoRadioP.nc"
static inline const orinoco_packet_statistics_t *OrinocoRadioP__PacketStatistics__get(void )
#line 612
{
...
#line 55
# 586 "../../lib/net/orinoco/OrinocoQueueP.nc"
static inline const orinoco_queue_statistics_t *OrinocoQueueP__QueueStatistics__get(void )
#line 586
{
...
#line 65
# 95 "../../lib/net/orinoco/RadioTestC.nc"
static inline uint8_t RadioTestC__VerSize__getVersionSize(void )
#line 95
{
  return DATA_VERSION_SIZE;
}

# 2 "../../lib/net/orinoco/OrinocoDataSizeInterface.nc"
inline static uint8_t OrinocoRadioP__VerSize__getVersionSize(void ){
#line 2
  unsigned char __nesc_result;
#line 2

#line 2
  __nesc_result = RadioTestC__VerSize__getVersionSize();
#line 2
...
#line 126
# 152 "../../lib/net/orinoco/OrinocoPacketDelayLayerP.nc"
static inline void *OrinocoPacketDelayLayerP__Packet__getPayload(message_t *msg, uint8_t len)
#line 152
{
...
#line 126
# 1208 "../../lib/net/orinoco/OrinocoRadioP.nc"
static inline void *OrinocoRadioP__Packet__getPayload(message_t *msg, uint8_t len)
#line 1208
{
  return OrinocoRadioP__SubPacket__getPayload(msg, len + OrinocoRadioP__VerSize__getVersionSize());
}
...
#line 126
# 529 "../../lib/net/orinoco/OrinocoQueueP.nc"
static inline void *OrinocoQueueP__Packet__getPayload(message_t *msg, uint8_t len)
#line 529
{
...
# 43 "../../../EAJobs/interfaces/EAJob.nc"
inline static void EASchedulerP__EAJob__run(uint8_t arg_0x2b1f96810608){
#line 43
  switch (arg_0x2b1f96810608) {
#line 43
...
#line 43
    default:
#line 43
      EASchedulerP__EAJob__default__run(arg_0x2b1f96810608);
#line 43
      break;
#line 43
    }
...
# 43 "../../../EAJobs/interfaces/EAJobConfig.nc"
inline static ea_generic_jobconfig_t *EAEnergyManagerP__EAJobConfig__getConfig(uint8_t arg_0x2b1f96868498){
#line 43
  struct ea_generic_jobconfig_t *__nesc_result;
#line 43

#line 43
  switch (arg_0x2b1f96868498) {
#line 43
    case /*OrinocoTrafficStatisticsC.Job*/EAJobC__0__JOB_ID:
#line 43
...
#line 43
    default:
#line 43
      __nesc_result = EAEnergyManagerP__EAJobConfig__default__getConfig(arg_0x2b1f96868498);
#line 43
      break;
#line 43
    }
...
#line 41
# 212 "../../lib/net/orinoco/OrinocoTrafficStatisticsP.nc"
static inline uint32_t OrinocoTrafficStatisticsP__PktRateJobConfig__getPeriod(void )
#line 212
{
  return 180 * 1024UL;
...
#line 162
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0x2b1f9635f650, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*SerialActiveMessageC.AM*/SerialActiveMessageP__0__AMSend__send(arg_0x2b1f9635f650, addr, msg, len);
#line 80
...
# 23 "/opt/tinyos-2.1.2/tos/lib/serial/SerialPacketInfo.nc"
inline static uint8_t /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__dataLinkLength(uart_id_t arg_0x2b1f964bc308, message_t *msg, uint8_t upperLen){
#line 23
  unsigned char __nesc_result;
#line 23

#line 23
  switch (arg_0x2b1f964bc308) {
#line 23
...
#line 23
    default:
#line 23
      __nesc_result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__default__dataLinkLength(arg_0x2b1f964bc308, msg, upperLen);
#line 23
      break;
#line 23
    }
...
inline static uint8_t /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__offset(uart_id_t arg_0x2b1f964bc308){
#line 15
  unsigned char __nesc_result;
#line 15
...
#line 15
    default:
#line 15
      __nesc_result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__default__offset(arg_0x2b1f964bc308);
#line 15
      break;
#line 15
    }
...
# 102 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static void /*Msp430Uart1P.UartP*/Msp430UartP__0__Resource__granted(uint8_t arg_0x2b1f965907e8){
#line 102
  switch (arg_0x2b1f965907e8) {
#line 102
...
#line 102
    default:
#line 102
      /*Msp430Uart1P.UartP*/Msp430UartP__0__Resource__default__granted(arg_0x2b1f965907e8);
#line 102
      break;
#line 102
    }
...
# 102 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static void /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__1__Resource__granted(uint8_t arg_0x2b1f95a78640){
#line 102
  switch (arg_0x2b1f95a78640) {
#line 102
...
#line 102
    default:
#line 102
      /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__1__Resource__default__granted(arg_0x2b1f95a78640);
#line 102
      break;
#line 102
    }
...
# 59 "/opt/tinyos-2.1.2/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__1__ResourceConfigure__configure(uint8_t arg_0x2b1f95a749b8){
#line 59
  switch (arg_0x2b1f95a749b8) {
#line 59
    case /*PlatformSerialC.UartC.UsartC*/Msp430Usart1C__0__CLIENT_ID:
...
#line 59
    default:
#line 59
      /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__1__ResourceConfigure__default__configure(arg_0x2b1f95a749b8);
#line 59
      break;
#line 59
    }
...
# 39 "/opt/tinyos-2.1.2/tos/chips/msp430/usart/Msp430UartConfigure.nc"
inline static msp430_uart_union_config_t */*Msp430Uart1P.UartP*/Msp430UartP__0__Msp430UartConfigure__getConfig(uint8_t arg_0x2b1f9658acd0){
#line 39
  union __nesc_unnamed4306 *__nesc_result;
#line 39

#line 39
  switch (arg_0x2b1f9658acd0) {
#line 39
    case /*PlatformSerialC.UartC*/Msp430Uart1C__0__CLIENT_ID:
#line 39
...
#line 39
    default:
#line 39
      __nesc_result = /*Msp430Uart1P.UartP*/Msp430UartP__0__Msp430UartConfigure__default__getConfig(arg_0x2b1f9658acd0);
#line 39
      break;
#line 39
    }
...
# 100 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
inline static void /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__sendDone(uint8_t arg_0x2b1f96360430, message_t * msg, error_t error){
#line 100
  switch (arg_0x2b1f96360430) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__default__sendDone(arg_0x2b1f96360430, msg, error);
#line 100
      break;
#line 100
    }
...
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static void /*SerialActiveMessageC.AM*/SerialActiveMessageP__0__AMSend__sendDone(am_id_t arg_0x2b1f96385ba8, message_t * msg, error_t error){
#line 110
  /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__sendDone(arg_0x2b1f96385ba8, msg, error);
#line 110
}
#line 110
...
# 100 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
inline static void /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__Send__sendDone(uart_id_t arg_0x2b1f964bd020, message_t * msg, error_t error){
#line 100
  switch (arg_0x2b1f964bd020) {
#line 100
    case TOS_SERIAL_ACTIVE_MESSAGE_ID:
#line 100
...
#line 100
    default:
#line 100
      /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__Send__default__sendDone(arg_0x2b1f964bd020, msg, error);
#line 100
      break;
#line 100
    }
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * /*SerialActiveMessageC.AM*/SerialActiveMessageP__0__Receive__receive(am_id_t arg_0x2b1f96382cd0, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = /*SerialActiveMessageC.AM*/SerialActiveMessageP__0__Receive__default__receive(arg_0x2b1f96382cd0, msg, payload, len);
#line 78
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__Receive__receive(uart_id_t arg_0x2b1f964bf3e0, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x2b1f964bf3e0) {
#line 78
    case TOS_SERIAL_ACTIVE_MESSAGE_ID:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__Receive__default__receive(arg_0x2b1f964bf3e0, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 31 "/opt/tinyos-2.1.2/tos/lib/serial/SerialPacketInfo.nc"
inline static uint8_t /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__upperLength(uart_id_t arg_0x2b1f964bc308, message_t *msg, uint8_t dataLinkLen){
#line 31
  unsigned char __nesc_result;
#line 31
...
#line 31
    default:
#line 31
      __nesc_result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__default__upperLength(arg_0x2b1f964bc308, msg, dataLinkLen);
#line 31
      break;
#line 31
    }
...
# 65 "/opt/tinyos-2.1.2/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__1__ResourceConfigure__unconfigure(uint8_t arg_0x2b1f95a749b8){
#line 65
  switch (arg_0x2b1f95a749b8) {
#line 65
    case /*PlatformSerialC.UartC.UsartC*/Msp430Usart1C__0__CLIENT_ID:
...
#line 65
    default:
#line 65
      /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__1__ResourceConfigure__default__unconfigure(arg_0x2b1f95a749b8);
#line 65
      break;
#line 65
    }
...
# 120 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static error_t /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__release(uint8_t arg_0x2b1f9658ba20){
#line 120
  unsigned char __nesc_result;
#line 120

#line 120
  switch (arg_0x2b1f9658ba20) {
#line 120
    case /*PlatformSerialC.UartC*/Msp430Uart1C__0__CLIENT_ID:
#line 120
...
#line 120
    default:
#line 120
      __nesc_result = /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__default__release(arg_0x2b1f9658ba20);
#line 120
      break;
#line 120
    }
...
# 128 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static bool /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__isOwner(uint8_t arg_0x2b1f9658ba20){
#line 128
  unsigned char __nesc_result;
#line 128
...
#line 128
    default:
#line 128
      __nesc_result = /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__default__isOwner(arg_0x2b1f9658ba20);
#line 128
      break;
#line 128
    }
...
# 61 "/opt/tinyos-2.1.2/tos/interfaces/ResourceRequested.nc"
inline static void /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__1__ResourceRequested__immediateRequested(uint8_t arg_0x2b1f95a777e8){
#line 61
    /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__1__ResourceRequested__default__immediateRequested(arg_0x2b1f95a777e8);
#line 61
}
#line 61
# 93 "/opt/tinyos-2.1.2/tos/system/ArbiterP.nc"
...
# 97 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static error_t /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__immediateRequest(uint8_t arg_0x2b1f9658ba20){
#line 97
  unsigned char __nesc_result;
#line 97
...
#line 97
    default:
#line 97
      __nesc_result = /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__default__immediateRequest(arg_0x2b1f9658ba20);
#line 97
      break;
#line 97
    }
...
# 133 "../../lib/net/orinoco/RadioTestC.nc"
static inline const CloudCoverMAX *RadioTestC__Value__get(void )
#line 133
{
  return &RadioTestC__paket;
}

# 55 "/opt/tinyos-2.1.2/tos/lib/net/DisseminationValue.nc"
inline static const TestC__Value__t *TestC__Value__get(void ){
#line 55
  nx_struct CloudCoverMAX const *__nesc_result;
#line 55

#line 55
  __nesc_result = RadioTestC__Value__get();
#line 55
...
{
  uint32_t timestamp;
  const CloudCoverMAX *CC = TestC__Value__get();

#line 122
  timestamp = __nesc_ntoh_uint8(CC->header_ZMsbAM.nxdata) & HEADER_TIME_MSB;
  timestamp = timestamp << HEADER_TIME_MSB_OFFSET;
  timestamp = timestamp | __nesc_ntoh_uint16(CC->header_ZLsb.nxdata);
  printf("%u,%lu: BL %u,%u,%u,%lu\n", TOS_NODE_ID, TestC__LocalTime__get(), __nesc_ntoh_uint8(CC->data[2].nxdata), __nesc_ntoh_uint8(CC->data[3].nxdata), __nesc_ntoh_uint8(CC->header_VA.nxdata), timestamp);
  printfflush();
}

# 69 "/opt/tinyos-2.1.2/tos/lib/net/DisseminationValue.nc"
inline static void RadioTestC__Value__changed(void ){
#line 69
  TestC__Value__changed();
#line 69
}
#line 69
# 105 "../../lib/net/orinoco/RadioTestC.nc"
static inline void RadioTestC__changedTask__runTask(void )
#line 105
{
  RadioTestC__Value__changed();
}

# 282 "../../lib/net/orinoco/DecodeC.nc"
static inline void DecodeC__decode1nextValue(nx_uint8_t *data, uint8_t *value, uint8_t *arrSize, uint8_t *posi)
#line 282
{
  uint8_t token = 0;
  ...
  for (i = 0; i < MAX_CODE; i++) {
      token = token << 1;
      token += DecodeC__getPosBitstreamR(data, *arrSize, posi, 1);
      if (token == 0) {
          break;
        }
      else {
...
#line 308
                if (token == 31) {
                    *value = DecodeC__getPosBitstreamR(data, *arrSize, posi, 4);
                    break;
                  }
                }
              }
...
#line 333
  *arrSize = n;
  sunRise = DecodeC__getPosBitstreamR(data, *arrSize, &posi, 5);
  sunSet = DecodeC__getPosBitstreamR(data, *arrSize, &posi, 5);
  ...
  for (j = 0; j < n; j++) {
      ...
      if (sunRise > sunSet) {
          if (mode == 0) {
              DecodeC__decode0nextValue(data, &value, arrSize, &posi);
            }
          else {
              DecodeC__decode1nextValue(data, &value, arrSize, &posi);
            }
          output[j] = value;
        }
      else {
...
# 4 "../../lib/net/orinoco/Decoder.nc"
inline static void RadioTestC__Decoder__decode(nx_uint8_t *data, uint8_t n, uint8_t output[], uint8_t *arrSize, uint8_t mode){
#line 4
  DecodeC__Decoder__decode(data, n, output, arrSize, mode);
#line 4
}
#line 4
# 45 "../../lib/net/orinoco/RadioTestC.nc"
static inline void RadioTestC__parseCloudCoverHeader(uint8_t *version, uint8_t *size, uint8_t *mode, uint32_t *timeStamp, uint8_t *resolution)
#line 45
{
  *size = ((__nesc_ntoh_uint8(RadioTestC__paket.header_VA.nxdata) & HEADER_VALUES_OFFSET) + 1) * NUMBER_OF_VALUES_FACTOR;

  *version = __nesc_ntoh_uint8(RadioTestC__paket.header_VA.nxdata) >> HEADER_VERSION_OFFSET;
  *mode = __nesc_ntoh_uint8(RadioTestC__paket.header_ZMsbAM.nxdata) & HEADER_MODE_OFFSET;
  *resolution = __nesc_ntoh_uint8(RadioTestC__paket.header_ZMsbAM.nxdata) & HEADER_RESOLUTION_OFFSET;
  *timeStamp = __nesc_ntoh_uint8(RadioTestC__paket.header_ZMsbAM.nxdata) & HEADER_TIME_MSB;
  *timeStamp = *timeStamp << HEADER_TIME_MSB_OFFSET;
  *timeStamp = *timeStamp | __nesc_ntoh_uint16(RadioTestC__paket.header_ZLsb.nxdata);
}
...
#line 56
{
  ...
  if (RadioTestC__ccPackageLength >= CC_HEADER_MIN_SIZE) {
      RadioTestC__parseCloudCoverHeader(&Version, &anzahl, &mode, &zeitStempel, &resolution);
      ...
      RadioTestC__Decoder__decode(RadioTestC__paket.data, anzahl, &decodedData[0], &maxIndex, mode);
...
# 102 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static void CC2420TinyosNetworkP__Resource__granted(uint8_t arg_0x2b1f96023280){
#line 102
  switch (arg_0x2b1f96023280) {
#line 102
...
#line 102
    default:
#line 102
      CC2420TinyosNetworkP__Resource__default__granted(arg_0x2b1f96023280);
#line 102
      break;
#line 102
    }
...
# 59 "/opt/tinyos-2.1.2/tos/interfaces/SendNotifier.nc"
inline static void CC2420ActiveMessageP__SendNotifier__aboutToSend(am_id_t arg_0x2b1f960d9258, am_addr_t dest, message_t * msg){
#line 59
    CC2420ActiveMessageP__SendNotifier__default__aboutToSend(arg_0x2b1f960d9258, dest, msg);
#line 59
}
#line 59
# 75 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
...
#line 51
# 199 "/opt/tinyos-2.1.2/tos/chips/cc2420/csma/CC2420CsmaP.nc"
static inline void CC2420CsmaP__RadioBackoff__setCca(bool useCca)
#line 199
{
...
#line 73
# 274 "/opt/tinyos-2.1.2/tos/chips/cc2420/CC2420ActiveMessageP.nc"
static inline void CC2420ActiveMessageP__RadioBackoff__setCca(am_id_t amId, bool useCca)
#line 274
{
...
# 73 "/opt/tinyos-2.1.2/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void OrinocoCC2420ModificationsP__RadioBackoff__setCca(am_id_t arg_0x2b1f9673d020, bool ccaOn){
#line 73
  CC2420ActiveMessageP__RadioBackoff__setCca(arg_0x2b1f9673d020, ccaOn);
#line 73
}
#line 73
# 55 "../../chips/cc2420/OrinocoCC2420ModificationsP.nc"
static inline void OrinocoCC2420ModificationsP__RadioBackoff__requestCca(am_id_t amId, message_t *msg)
#line 55
{
  OrinocoCC2420ModificationsP__RadioBackoff__setCca(amId, FALSE);
}

# 95 "/opt/tinyos-2.1.2/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestCca(am_id_t arg_0x2b1f960d9d60, message_t * msg){
#line 95
  OrinocoCC2420ModificationsP__RadioBackoff__requestCca(arg_0x2b1f960d9d60, msg);
#line 95
}
#line 95
...
#line 80
  __nesc_result = CC2420ActiveMessageP__AMSend__send(ORINOCO_AM_DATA, addr, msg, len);
#line 80
...
#line 61
# 72 "../../lib/net/orinoco/OrinocoPacketDelayLayerP.nc"
static inline error_t OrinocoPacketDelayLayerP__AMSend__send(am_addr_t dst, message_t *msg, uint8_t len)
#line 72
{
...
#line 81
  ...
  (__nesc_temp53 = OrinocoPacketDelayLayerP__getFooter(msg)->ctime.nxdata, __nesc_hton_uint32(__nesc_temp53, __nesc_ntoh_uint32(__nesc_temp53) - (now + OrinocoPacketDelayLayerP__delay)));
...
#line 67
# 261 "../../lib/net/orinoco/OrinocoQueueP.nc"
static inline error_t OrinocoQueueP__RootControl__isRoot(void )
#line 261
{
...
# 48 "../../lib/net/orinoco/OrinocoPathCost.nc"
...
#line 48
# 61 "/opt/tinyos-2.1.2/tos/lib/timer/LocalTime.nc"
inline static uint32_t OrinocoRadioP__LocalTime__get(void ){
#line 61
  unsigned long __nesc_result;
#line 61
...
#line 61
# 659 "../../lib/net/orinoco/OrinocoRadioP.nc"
static inline void OrinocoRadioP__Timer__fired(void )
#line 659
{
...
#line 685
    ...
    if (OrinocoRadioP__state_ == OrinocoRadioP__FORWARD_ACK) {
        ...
        printf("%u,%lu: Miss \n", TOS_NODE_ID, OrinocoRadioP__LocalTime__get());
        printfflush();
      }
    else {
...
# 66 "../../interfaces/QueueSend.nc"
inline static error_t TestC__Send__send(collection_id_t arg_0x2b1f94efe198, message_t * msg, uint8_t len){
#line 66
  unsigned char __nesc_result;
#line 66

#line 66
  __nesc_result = OrinocoQueueP__Send__send(arg_0x2b1f94efe198, msg, len);
#line 66
...
#line 66
# 65 "/opt/tinyos-2.1.2/tos/interfaces/Packet.nc"
inline static void TestC__Packet__clear(message_t * msg){
#line 65
  OrinocoQueueP__Packet__clear(msg);
#line 65
}
#line 65
#line 126
inline static void * TestC__Packet__getPayload(message_t * msg, uint8_t len){
#line 126
  void *__nesc_result;
#line 126
...
#line 147
{
  ...
  for (msgCnt = 0; msgCnt < 1; msgCnt++) {
      nx_uint16_t *d = TestC__Packet__getPayload(&TestC__myMsg, sizeof  (*d));

#line 153
      TestC__Packet__clear(&TestC__myMsg);
      __nesc_hton_uint16((*d).nxdata, TestC__cnt++);
      result = TestC__Send__send(33, &TestC__myMsg, sizeof  (*d));
      if (SUCCESS == result) {

          printf("%u,%lu: data-tx %u\n", TOS_NODE_ID, TestC__LocalTime__get(), __nesc_ntoh_uint16((*d).nxdata));
          printfflush();
        }
      else 
#line 160
  ...
  TestC__Timer__startOneShot(TestC__delay);
}
...
#line 140
{
  ...
  printf("%u,%lu: reset\n", TOS_NODE_ID, TestC__LocalTime__get());
  printfflush();
}
...
# 83 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x2b1f95f2e5d8){
#line 83
  switch (arg_0x2b1f95f2e5d8) {
#line 83
    case 1U:
#line 83
...
#line 83
    case 5U:
#line 83
      TestC__BootTimer__fired();
#line 83
      break;
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x2b1f95f2e5d8);
#line 83
      break;
#line 83
    }
...
#line 106
# 1204 "../../lib/net/orinoco/OrinocoRadioP.nc"
static inline uint8_t OrinocoRadioP__Packet__maxPayloadLength(void )
#line 1204
{
  return OrinocoRadioP__SubPacket__maxPayloadLength() - OrinocoRadioP__VerSize__getVersionSize();
}
...
#line 106
# 525 "../../lib/net/orinoco/OrinocoQueueP.nc"
static inline uint8_t OrinocoQueueP__Packet__maxPayloadLength(void )
#line 525
{
  return OrinocoQueueP__SubPacket__maxPayloadLength() - sizeof(orinoco_data_header_t );
}
...
#line 384
{
  return OrinocoQueueP__Packet__maxPayloadLength();
}

# 89 "../../lib/net/orinoco/OrinocoTrafficStatisticsP.nc"
static inline void OrinocoTrafficStatisticsP__Updates__updatePktCreationIntvl(void )
#line 89
{
  OrinocoTrafficStatisticsP__tv_.numPktCreated++;
}

# 45 "../../lib/net/orinoco/OrinocoTrafficUpdates.nc"
inline static void OrinocoQueueP__TrafficUpdates__updatePktCreationIntvl(void ){
#line 45
  OrinocoTrafficStatisticsP__Updates__updatePktCreationIntvl();
#line 45
}
#line 45
# 42 "/opt/tinyos-2.1.2/tos/chips/cc2420/interfaces/CC2420PacketBody.nc"
...
# 94 "/opt/tinyos-2.1.2/tos/interfaces/Packet.nc"
inline static void OrinocoPacketDelayLayerP__SubPacket__setPayloadLength(message_t * msg, uint8_t len){
#line 94
  CC2420ActiveMessageP__Packet__setPayloadLength(msg, len);
#line 94
}
#line 94
# 144 "../../lib/net/orinoco/OrinocoPacketDelayLayerP.nc"
static inline void OrinocoPacketDelayLayerP__Packet__setPayloadLength(message_t *msg, uint8_t len)
#line 144
{
  OrinocoPacketDelayLayerP__SubPacket__setPayloadLength(msg, len + sizeof(orinoco_delay_footer_t ));
}

# 94 "/opt/tinyos-2.1.2/tos/interfaces/Packet.nc"
inline static void OrinocoRadioP__SubPacket__setPayloadLength(message_t * msg, uint8_t len){
#line 94
  OrinocoPacketDelayLayerP__Packet__setPayloadLength(msg, len);
#line 94
}
#line 94
# 1200 "../../lib/net/orinoco/OrinocoRadioP.nc"
static inline void OrinocoRadioP__Packet__setPayloadLength(message_t *msg, uint8_t len)
#line 1200
{
  OrinocoRadioP__SubPacket__setPayloadLength(msg, len + OrinocoRadioP__VerSize__getVersionSize());
}

# 94 "/opt/tinyos-2.1.2/tos/interfaces/Packet.nc"
inline static void OrinocoQueueP__SubPacket__setPayloadLength(message_t * msg, uint8_t len){
#line 94
  OrinocoRadioP__Packet__setPayloadLength(msg, len);
#line 94
}
#line 94
# 521 "../../lib/net/orinoco/OrinocoQueueP.nc"
static inline void OrinocoQueueP__Packet__setPayloadLength(message_t *msg, uint8_t len)
#line 521
{
  OrinocoQueueP__SubPacket__setPayloadLength(msg, len + sizeof(orinoco_data_header_t ));
}

# 158 "../../lib/net/orinoco/OrinocoPacketDelayLayerP.nc"
static inline void OrinocoPacketDelayLayerP__PacketDelayMilli__init(message_t *msg)
#line 158
{
  __nesc_hton_uint32(OrinocoPacketDelayLayerP__getFooter(msg)->ctime.nxdata, OrinocoPacketDelayLayerP__LocalTimeMilli__get());
}

# 44 "../../interfaces/PacketDelay.nc"
inline static void OrinocoQueueP__PacketDelayMilli__init(message_t *msg){
#line 44
  OrinocoPacketDelayLayerP__PacketDelayMilli__init(msg);
#line 44
}
#line 44
# 129 "../../lib/net/orinoco/OrinocoConfigP.nc"
static inline uint8_t OrinocoConfigP__OrinocoConfig__getMinQueueSize(void )
#line 129
{
...
# 84 "../../interfaces/OrinocoConfig.nc"
...
#line 78
# 1115 "../../lib/net/orinoco/OrinocoRadioP.nc"
static inline error_t OrinocoRadioP__Send__send(message_t *msg, uint8_t len)
#line 1115
{
...
#line 78
# 986 "../../lib/net/orinoco/OrinocoRadioP.nc"
static inline message_t *OrinocoRadioP__DataSubSnoop__receive(message_t *msg, void *payload, uint8_t len)
#line 986
{
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * CC2420ActiveMessageP__Snoop__receive(am_id_t arg_0x2b1f960dc480, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x2b1f960dc480) {
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = CC2420ActiveMessageP__Snoop__default__receive(arg_0x2b1f960dc480, msg, payload, len);
#line 78
      break;
#line 78
    }
...
#line 67
# 750 "../../lib/net/orinoco/OrinocoRadioP.nc"
static inline void OrinocoRadioP__QueueStatus__dropped(void )
#line 750
{
...
#line 97
# 165 "../../lib/net/orinoco/OrinocoQueueP.nc"
static inline message_t * OrinocoQueueP__forward(message_t * msg)
#line 165
{
  mq_entry_t qe;
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * OrinocoQueueP__Receive__receive(collection_id_t arg_0x2b1f94f879d8, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  __nesc_result = TestC__RadioReceive__receive(arg_0x2b1f94f879d8, msg, payload, len);
#line 78
...
#line 78
# 410 "../../lib/net/orinoco/OrinocoQueueP.nc"
static inline bool OrinocoQueueP__Intercept__default__forward(collection_id_t collectid, message_t *msg, void *payload, uint8_t len)
#line 410
{
  return TRUE;
...
# 31 "/opt/tinyos-2.1.2/tos/interfaces/Intercept.nc"
inline static bool OrinocoQueueP__Intercept__forward(collection_id_t arg_0x2b1f94f85270, message_t * msg, void * payload, uint8_t len){
#line 31
  unsigned char __nesc_result;
#line 31

#line 31
    __nesc_result = OrinocoQueueP__Intercept__default__forward(arg_0x2b1f94f85270, msg, payload, len);
#line 31
...
#line 62
{
  if (/*OrinocoP.PacketHistory*/OrinocoCacheC__0__newest == 0) {
      /*OrinocoP.PacketHistory*/OrinocoCacheC__0__newest = 40 - 1;
    }
  else 
#line 65
    {
  ...
  if (/*OrinocoP.PacketHistory*/OrinocoCacheC__0__len < 40) {
#line 69
...
#line 51
# 579 "../../lib/net/orinoco/OrinocoQueueP.nc"
static inline bool OrinocoQueueP__CacheCompare__equal(mc_entry_t ce, mc_entry_t cmp)
#line 579
{
...
#line 78
# 140 "../../lib/net/orinoco/OrinocoPacketDelayLayerP.nc"
static inline uint8_t OrinocoPacketDelayLayerP__Packet__payloadLength(message_t *msg)
#line 140
{
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Packet.nc"
inline static uint8_t OrinocoRadioP__SubPacket__payloadLength(message_t * msg){
#line 78
  unsigned char __nesc_result;
#line 78
...
#line 78
# 1196 "../../lib/net/orinoco/OrinocoRadioP.nc"
static inline uint8_t OrinocoRadioP__Packet__payloadLength(message_t *msg)
#line 1196
{
  return OrinocoRadioP__SubPacket__payloadLength(msg) - OrinocoRadioP__VerSize__getVersionSize();
}
...
#line 78
# 517 "../../lib/net/orinoco/OrinocoQueueP.nc"
static inline uint8_t OrinocoQueueP__Packet__payloadLength(message_t *msg)
#line 517
{
...
# 103 "../../lib/net/orinoco/OrinocoTrafficStatisticsP.nc"
static inline void OrinocoTrafficStatisticsP__Updates__updatePktReceptionIntvl(void )
#line 103
{
...
#line 48
# 447 "../../lib/net/orinoco/OrinocoQueueP.nc"
static inline message_t *
OrinocoQueueP__SubReceive__receive(message_t *msg, void *payload, uint8_t len)
#line 448
{
...
#line 506
      {
        OrinocoQueueP__Receive__receive(__nesc_ntoh_uint8(h->type.nxdata), msg, OrinocoQueueP__Packet__getPayload(msg, len), len);
...
#line 78
# 173 "../../lib/net/orinoco/RadioTestC.nc"
static inline void RadioTestC__Orinoco__receivedData(void *data, uint8_t len)
#line 173
{
  uint8_t localVer = __nesc_ntoh_uint8(RadioTestC__paket.header_VA.nxdata) >> HEADER_VERSION_OFFSET;
  uint8_t receivedVer = 0;

  uint8_t *ver = (uint8_t *)data;
  ...
  if (ver != (void *)0) {
      ...
      if (localVer > receivedVer && localVer - receivedVer <= VERSION_DIFF) {

          RadioTestC__isNew = 1;
        }
      else {
#line 188
        if (localVer < receivedVer && receivedVer - localVer > VERSION_DIFF) {
...
# 3 "../../lib/net/orinoco/OrinocoDataInterface.nc"
inline static void OrinocoRadioP__OrinocoDI__receivedData(void *data, uint8_t len){
#line 3
  RadioTestC__Orinoco__receivedData(data, len);
#line 3
}
#line 3
# 56 "../../lib/net/orinoco/OrinocoTrafficUpdates.nc"
...
#line 56
# 222 "../../lib/net/orinoco/OrinocoQueueP.nc"
static inline uint16_t OrinocoQueueP__OrinocoRoutingStateInternal__getPacketRoutingInformationVersion(message_t *msg)
#line 222
{
  orinoco_data_header_t *hdr = OrinocoQueueP__getHeader(msg);

#line 224
  return __nesc_ntoh_uint16(hdr->routingVersion.nxdata);
}

# 45 "../../interfaces/OrinocoRoutingStateInternal.nc"
inline static uint16_t OrinocoRadioP__RoutingState__getPacketRoutingInformationVersion(message_t *msg){
#line 45
  unsigned int __nesc_result;
#line 45

#line 45
  __nesc_result = OrinocoQueueP__OrinocoRoutingStateInternal__getPacketRoutingInformationVersion(msg);
#line 45
...
#line 88
# 913 "../../lib/net/orinoco/OrinocoRadioP.nc"
static inline message_t *OrinocoRadioP__DataSubReceive__receive(message_t *msg, void *payload, uint8_t len)
#line 913
{
  ;
  ...
  if (OrinocoRadioP__state_ == OrinocoRadioP__RECEIVE || OrinocoRadioP__state_ == OrinocoRadioP__RECEIVE_TIMER) {
      ...
      OrinocoRadioP__rxRouteVersion_ = OrinocoRadioP__RoutingState__getPacketRoutingInformationVersion(msg);
      ...
      OrinocoRadioP__OrinocoDI__receivedData(payload + OrinocoRadioP__Packet__payloadLength(msg), OrinocoRadioP__VerSize__getVersionSize());
...
#line 78
# 129 "../../lib/net/orinoco/OrinocoPacketDelayLayerP.nc"
static inline message_t *OrinocoPacketDelayLayerP__SubReceive__receive(message_t *msg, void *payload, uint8_t len)
#line 129
{
...
#line 130
  (__nesc_temp54 = OrinocoPacketDelayLayerP__getFooter(msg)->ctime.nxdata, __nesc_hton_uint32(__nesc_temp54, __nesc_ntoh_uint32(__nesc_temp54) + OrinocoPacketDelayLayerP__LocalTimeMilli__get()));
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * CC2420ActiveMessageP__Receive__receive(am_id_t arg_0x2b1f960de908, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x2b1f960de908) {
#line 78
    case ORINOCO_AM_BEACON:
#line 78
      __nesc_result = OrinocoRadioP__BeaconSubReceive__receive(msg, payload, len);
...
#line 78
    default:
#line 78
      __nesc_result = CC2420ActiveMessageP__Receive__default__receive(arg_0x2b1f960de908, msg, payload, len);
#line 78
      break;
#line 78
    }
...
#line 78
# 219 "/opt/tinyos-2.1.2/tos/chips/cc2420/CC2420ActiveMessageP.nc"
static inline message_t *CC2420ActiveMessageP__SubReceive__receive(message_t *msg, void *payload, uint8_t len)
#line 219
{
...
#line 87
  ...
  if (!/*OrinocoP.SendQueue*/QueueC__0__Queue__empty()) {
      ...
      if (/*OrinocoP.SendQueue*/QueueC__0__head == 30) {
#line 90
...
#line 73
# 416 "../../lib/net/orinoco/OrinocoQueueP.nc"
static inline void OrinocoQueueP__SubSend__sendDone(message_t *msg, error_t error)
#line 416
{
  ...
  if (msg == OrinocoQueueP__SendQueue__head().msg) {
      ...
      if (error == SUCCESS) {
...

        {
          ...
          h = OrinocoQueueP__getHeader(msg);
          printf("%u ZZ %u %u %u %u %p\n", TOS_NODE_ID, __nesc_ntoh_uint16(h->origin.nxdata), __nesc_ntoh_uint8(h->seqno.nxdata), __nesc_ntoh_uint8(h->hopCnt.nxdata), __nesc_ntoh_uint16(h->routingVersion.nxdata), msg);
          printfflush();
        }
...
#line 100
# 61 "/opt/tinyos-2.1.2/tos/lib/timer/LocalTime.nc"
inline static uint32_t RadioTestC__LocalTimeMilli__get(void ){
#line 61
  unsigned long __nesc_result;
#line 61
...
#line 61
# 67 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
inline static error_t RadioTestC__decodingTask__postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SchedulerBasicP__TaskBasic__postTask(RadioTestC__decodingTask);
#line 67
...
#line 67
inline static error_t RadioTestC__changedTask__postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SchedulerBasicP__TaskBasic__postTask(RadioTestC__changedTask);
#line 67
...
#line 67
# 249 "../../lib/net/orinoco/RadioTestC.nc"
static inline void RadioTestC__Orinoco__receivedBeacon(void *data, uint8_t len)
#line 249
{
  ...
  if (len > 0) {
      ...
      CloudCoverHeader *cc = (CloudCoverHeader *)data;



      __nesc_hton_uint16(RadioTestC__paket.header_ZLsb.nxdata, __nesc_ntoh_uint16(cc->header_ZLsb.nxdata));
      __nesc_hton_uint8(RadioTestC__paket.header_ZMsbAM.nxdata, __nesc_ntoh_uint8(cc->header_ZMsbAM.nxdata));
      __nesc_hton_uint8(RadioTestC__paket.header_VA.nxdata, __nesc_ntoh_uint8(cc->header_VA.nxdata));
      __nesc_hton_uint8(RadioTestC__paket.length.nxdata, len - CC_HEADER_MIN_SIZE);
      RadioTestC__ccPackageLength = len;

      memcpy(RadioTestC__paket.data, cc->data, __nesc_ntoh_uint8(RadioTestC__paket.length.nxdata));

      __nesc_hton_uint8(RadioTestC__paket.data[2].nxdata, __nesc_ntoh_uint8(RadioTestC__paket.data[2].nxdata) + 1);

      RadioTestC__tsTime = __nesc_ntoh_uint8(RadioTestC__paket.header_ZMsbAM.nxdata) & HEADER_TIME_MSB;
      RadioTestC__tsTime = RadioTestC__tsTime << HEADER_TIME_MSB_OFFSET;
      RadioTestC__tsTime = RadioTestC__tsTime | __nesc_ntoh_uint16(RadioTestC__paket.header_ZLsb.nxdata);
      RadioTestC__pStartTime = RadioTestC__LocalTimeMilli__get();


      RadioTestC__changedTask__postTask();



      if (RadioTestC__decodingTask__postTask() != SUCCESS) {
          printf("Task ist belegt\n");
        }
    }
  else 
    {
      printf("%u,%lu: BS RC\n", TOS_NODE_ID, RadioTestC__LocalTimeMilli__get());
      printfflush();
    }
}

# 8 "../../lib/net/orinoco/OrinocoDataInterface.nc"
inline static void OrinocoRadioP__OrinocoDI__receivedBeacon(void *data, uint8_t len){
#line 8
  RadioTestC__Orinoco__receivedBeacon(data, len);
#line 8
}
#line 8
# 61 "/opt/tinyos-2.1.2/tos/lib/timer/LocalTime.nc"
...
#line 47
# 80 "../../lib/net/orinoco/OrinocoPathCostHopCountP.nc"
static inline bool OrinocoPathCostHopCountP__OrinocoPathCost__inspectBeacon(message_t *msg, orinoco_pathcost_t cost, bool update)
#line 80
{
...
# 52 "../../lib/net/orinoco/OrinocoPathCost.nc"
...
# 48 "../../interfaces/OrinocoRoutingClient.nc"
inline static void OrinocoRoutingP__OrinocoRoutingClient__noMorePacketNotification(void ){
#line 48
  TestC__OrinocoRouting__noMorePacketNotification();
#line 48
}
#line 48
# 66 "../../interfaces/QueueSend.nc"
inline static error_t OrinocoRoutingP__Send__send(collection_id_t arg_0x2b1f9623b9d8, message_t * msg, uint8_t len){
#line 66
  unsigned char __nesc_result;
#line 66

#line 66
  __nesc_result = OrinocoQueueP__Send__send(arg_0x2b1f9623b9d8, msg, len);
#line 66
...
#line 66
# 126 "../../lib/net/orinoco/OrinocoRoutingP.nc"
static inline void OrinocoRoutingP__sendConfirmation(uint8_t cmd, uint16_t version, error_t status)
#line 126
{
  OrinocoCommandAckMsg *payload = (OrinocoCommandAckMsg *)OrinocoRoutingP__Packet__getPayload(&OrinocoRoutingP__myMsg, sizeof(OrinocoCommandAckMsg ));

#line 128
  __nesc_hton_uint8(payload->cmd.nxdata, cmd);
  __nesc_hton_uint16(payload->version.nxdata, version);
  __nesc_hton_uint8(payload->result.nxdata, status);
  ...
  OrinocoRoutingP__Send__send(ORINOCO_AM_CMDCFRM, &OrinocoRoutingP__myMsg, sizeof(OrinocoCommandAckMsg ));
}
...
#line 205
{
  OrinocoRoutingP__sendConfirmation(cmd, version, status);
}

# 51 "../../interfaces/OrinocoRoutingClient.nc"
inline static void TestC__OrinocoRouting__confirmCommandExecution(uint8_t cmd, uint16_t identifier, error_t status){
#line 51
  OrinocoRoutingP__OrinocoRoutingClient__confirmCommandExecution(cmd, identifier, status);
#line 51
}
#line 51
...
inline static void TestC__Leds__led2On(void ){
#line 89
  LedsP__Leds__led2On();
#line 89
}
...
# 72 "/opt/tinyos-2.1.2/tos/interfaces/Leds.nc"
inline static void TestC__Leds__led1On(void ){
#line 72
  LedsP__Leds__led1On();
#line 72
}
...
#line 170
{
  TestC__Timer__startOneShot(value);
  TestC__delay = value;
}
...
#line 206
  ...
  TestC__OrinocoRouting__confirmCommandExecution(cmd, identifier, returnCode);
}

# 45 "../../interfaces/OrinocoRoutingClient.nc"
inline static void OrinocoRoutingP__OrinocoRoutingClient__newCommandNotification(uint8_t cmd, uint16_t identifier){
#line 45
  TestC__OrinocoRouting__newCommandNotification(cmd, identifier);
#line 45
}
#line 45
# 112 "../../lib/net/orinoco/OrinocoRoutingP.nc"
static inline bool OrinocoRoutingP__checkForPresenceInFilter(void )
#line 112
{
...
#line 115
  for (i = 0; i < BLOOM_HASHES; i++) {
      offsetByte = OrinocoRoutingP__bp_.hashes[i] >> 0x03;
      offsetBit = 0x80 >> (OrinocoRoutingP__bp_.hashes[i] & 0x07);
      if ((__nesc_ntoh_uint8(OrinocoRoutingP__curRouting_.bloom[offsetByte].nxdata) & offsetBit) == 0) {
          return FALSE;
        }
    }
...
# 61 "/opt/tinyos-2.1.2/tos/lib/timer/LocalTime.nc"
inline static uint32_t OrinocoRoutingP__Clock__get(void ){
#line 61
  unsigned long __nesc_result;
#line 61
...
#line 61
# 224 "../../lib/net/orinoco/OrinocoRoutingP.nc"
static inline void OrinocoRoutingP__OrinocoRoutingInternal__updateBloomFilter(const orinoco_routing_t *route)
{
  uint8_t i;
  uint16_t rxVersion = __nesc_ntoh_uint16(route->version.nxdata);
  uint16_t myVersion = __nesc_ntoh_uint16(OrinocoRoutingP__curRouting_.version.nxdata);


  if (rxVersion == 16776) {

      printf("%lu: %u bf-bad-beacon\n", OrinocoRoutingP__Clock__get(), OrinocoRoutingP__localId_);
      printfflush();
...
#line 245
  ...
  if (rxVersion > myVersion || myVersion - rxVersion >= BLOOM_VERSION_MAX / 2) {
      ...
      __nesc_hton_uint16(OrinocoRoutingP__curRouting_.version.nxdata, rxVersion);
      __nesc_hton_uint8(OrinocoRoutingP__curRouting_.cmd.nxdata, __nesc_ntoh_uint8(route->cmd.nxdata));
      for (i = 0; i < BLOOM_BYTES; i++) {
          __nesc_hton_uint8(OrinocoRoutingP__curRouting_.bloom[i].nxdata, __nesc_ntoh_uint8(route->bloom[i].nxdata));
        }


      printf("%lu: %u bf-up %u %u\n", OrinocoRoutingP__Clock__get(), OrinocoRoutingP__localId_, myVersion, rxVersion);
      printfflush();




      OrinocoRoutingP__packetWaiting_ = OrinocoRoutingP__checkForPresenceInFilter();
      if (OrinocoRoutingP__packetWaiting_) {
          OrinocoRoutingP__OrinocoRoutingClient__newCommandNotification(__nesc_ntoh_uint8(OrinocoRoutingP__curRouting_.cmd.nxdata), __nesc_ntoh_uint16(OrinocoRoutingP__curRouting_.version.nxdata));
        }
      else 
#line 276
        {
          OrinocoRoutingP__OrinocoRoutingClient__noMorePacketNotification();
        }
    }
...
# 45 "../../interfaces/OrinocoRoutingInternal.nc"
inline static void OrinocoRadioP__Routing__updateBloomFilter(const orinoco_routing_t *newFilter){
#line 45
  OrinocoRoutingP__OrinocoRoutingInternal__updateBloomFilter(newFilter);
#line 45
}
#line 45
# 218 "../../lib/net/orinoco/OrinocoQueueP.nc"
static inline void OrinocoQueueP__OrinocoRoutingStateInternal__setRoutingInformationVersion(uint16_t ver)
#line 218
{
  OrinocoQueueP__routingVersion_ = ver;
}

# 48 "../../interfaces/OrinocoRoutingStateInternal.nc"
inline static void OrinocoRadioP__RoutingState__setRoutingInformationVersion(uint16_t version){
#line 48
  OrinocoQueueP__OrinocoRoutingStateInternal__setRoutingInformationVersion(version);
#line 48
}
#line 48
...
#line 78
# 200 "/opt/tinyos-2.1.2/tos/chips/cc2420/transmit/CC2420TransmitP.nc"
static inline error_t CC2420TransmitP__Send__cancel(void )
#line 200
{
  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
...
# 65 "/opt/tinyos-2.1.2/tos/chips/cc2420/interfaces/CC2420Transmit.nc"
...
#line 65
# 118 "/opt/tinyos-2.1.2/tos/chips/cc2420/csma/CC2420CsmaP.nc"
static inline error_t CC2420CsmaP__Send__cancel(message_t *p_msg)
#line 118
{
...
# 89 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
...
#line 89
# 90 "/opt/tinyos-2.1.2/tos/chips/cc2420/unique/UniqueSendP.nc"
static inline error_t UniqueSendP__Send__cancel(message_t *msg)
#line 90
{
...
#line 89
# 86 "/opt/tinyos-2.1.2/tos/chips/cc2420/lowpan/CC2420TinyosNetworkP.nc"
static inline error_t CC2420TinyosNetworkP__ActiveSend__cancel(message_t *msg)
#line 86
{
...
#line 89
# 122 "/opt/tinyos-2.1.2/tos/chips/cc2420/CC2420ActiveMessageP.nc"
static inline error_t CC2420ActiveMessageP__AMSend__cancel(am_id_t id, message_t *msg)
#line 122
{
...
#line 96
  __nesc_result = CC2420ActiveMessageP__AMSend__cancel(ORINOCO_AM_DATA, msg);
#line 96
...
#line 96
# 101 "../../lib/net/orinoco/OrinocoPacketDelayLayerP.nc"
static inline error_t OrinocoPacketDelayLayerP__AMSend__cancel(message_t *msg)
#line 101
{
...
#line 96
# 536 "../../lib/net/orinoco/OrinocoQueueP.nc"
static inline am_addr_t OrinocoQueueP__CollectionPacket__getOrigin(message_t *msg)
#line 536
{
...
# 43 "/opt/tinyos-2.1.2/tos/lib/net/CollectionPacket.nc"
inline static am_addr_t TestC__CollectionPacket__getOrigin(message_t *msg){
#line 43
  unsigned int __nesc_result;
#line 43
...
# 102 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static void /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Resource__granted(uint8_t arg_0x2b1f9588dcc0){
#line 102
  switch (arg_0x2b1f9588dcc0) {
#line 102
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC*/Msp430Spi0C__0__CLIENT_ID:
#line 102
...
#line 102
    default:
#line 102
      /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Resource__default__granted(arg_0x2b1f9588dcc0);
#line 102
      break;
#line 102
    }
...
# 102 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__Resource__granted(uint8_t arg_0x2b1f95a78640){
#line 102
  switch (arg_0x2b1f95a78640) {
#line 102
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
...
#line 102
    default:
#line 102
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__Resource__default__granted(arg_0x2b1f95a78640);
#line 102
      break;
#line 102
    }
...
# 82 "/opt/tinyos-2.1.2/tos/interfaces/SpiPacket.nc"
inline static void /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__SpiPacket__sendDone(uint8_t arg_0x2b1f95886e38, uint8_t * txBuf, uint8_t * rxBuf, uint16_t len, error_t error){
#line 82
  switch (arg_0x2b1f95886e38) {
#line 82
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC*/Msp430Spi0C__0__CLIENT_ID:
#line 82
...
#line 82
    default:
#line 82
      /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__SpiPacket__default__sendDone(arg_0x2b1f95886e38, txBuf, rxBuf, len, error);
#line 82
      break;
#line 82
    }
...
# 71 "/opt/tinyos-2.1.2/tos/chips/cc2420/interfaces/CC2420Fifo.nc"
inline static void CC2420SpiP__Fifo__readDone(uint8_t arg_0x2b1f957b6328, uint8_t * data, uint8_t length, error_t error){
#line 71
  switch (arg_0x2b1f957b6328) {
#line 71
    case CC2420_TXFIFO:
#line 71
...
#line 71
    default:
#line 71
      CC2420SpiP__Fifo__default__readDone(arg_0x2b1f957b6328, data, length, error);
#line 71
      break;
#line 71
    }
...
#line 60
# 256 "/opt/tinyos-2.1.2/tos/chips/cc2420/CC2420ActiveMessageP.nc"
static inline void CC2420ActiveMessageP__RadioBackoff__setInitialBackoff(am_id_t amId, uint16_t backoffTime)
#line 256
{
...
# 60 "/opt/tinyos-2.1.2/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void OrinocoCC2420ModificationsP__RadioBackoff__setInitialBackoff(am_id_t arg_0x2b1f9673d020, uint16_t backoffTime){
#line 60
  CC2420ActiveMessageP__RadioBackoff__setInitialBackoff(arg_0x2b1f9673d020, backoffTime);
#line 60
}
#line 60
# 47 "../../chips/cc2420/OrinocoCC2420ModificationsP.nc"
...
#line 47
{
  OrinocoCC2420ModificationsP__RadioBackoff__setInitialBackoff(amId, 0);
}

# 81 "/opt/tinyos-2.1.2/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestInitialBackoff(am_id_t arg_0x2b1f960d9d60, message_t * msg){
#line 81
  OrinocoCC2420ModificationsP__RadioBackoff__requestInitialBackoff(arg_0x2b1f960d9d60, msg);
#line 81
}
#line 81
...
# 91 "/opt/tinyos-2.1.2/tos/chips/cc2420/interfaces/CC2420Fifo.nc"
inline static void CC2420SpiP__Fifo__writeDone(uint8_t arg_0x2b1f957b6328, uint8_t * data, uint8_t length, error_t error){
#line 91
  switch (arg_0x2b1f957b6328) {
#line 91
    case CC2420_TXFIFO:
...
#line 91
    default:
#line 91
      CC2420SpiP__Fifo__default__writeDone(arg_0x2b1f957b6328, data, length, error);
#line 91
      break;
#line 91
    }
...
# 102 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static void CC2420SpiP__Resource__granted(uint8_t arg_0x2b1f957b8158){
#line 102
  switch (arg_0x2b1f957b8158) {
#line 102
...
#line 102
    default:
#line 102
      CC2420SpiP__Resource__default__granted(arg_0x2b1f957b8158);
#line 102
      break;
#line 102
    }
...
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static void CC2420ActiveMessageP__AMSend__sendDone(am_id_t arg_0x2b1f960df7d8, message_t * msg, error_t error){
#line 110
  switch (arg_0x2b1f960df7d8) {
#line 110
    case ORINOCO_AM_BEACON:
#line 110
...
#line 110
    default:
#line 110
      CC2420ActiveMessageP__AMSend__default__sendDone(arg_0x2b1f960df7d8, msg, error);
#line 110
      break;
#line 110
    }
...
#line 41
# 635 "../../lib/net/orinoco/OrinocoRadioP.nc"
static inline void OrinocoRadioP__SubControl__stopDone(error_t error)
#line 635
{
  ...
  if (error == SUCCESS) {
      OrinocoRadioP__energy += OrinocoRadioP__LocalTime__get();
      OrinocoRadioP__energyCounter++;
      if (OrinocoRadioP__energyCounter == 64) {
          printf("%u,%lu: EN %luX \n", TOS_NODE_ID, OrinocoRadioP__LocalTime__get(), OrinocoRadioP__energy);
          printfflush();
          OrinocoRadioP__energy = 0;
          OrinocoRadioP__energyCounter = 0;
        }
...
# 619 "../../lib/net/orinoco/OrinocoRadioP.nc"
static inline void OrinocoRadioP__SubControl__startDone(error_t error)
#line 619
{
...
#line 80
  __nesc_result = CC2420ActiveMessageP__AMSend__send(ORINOCO_AM_BEACON, addr, msg, len);
#line 80
...
inline static uint8_t OrinocoRadioP__BeaconSubSend__maxPayloadLength(void ){
#line 123
  unsigned char __nesc_result;
#line 123

#line 123
  __nesc_result = CC2420ActiveMessageP__AMSend__maxPayloadLength(ORINOCO_AM_BEACON);
#line 123
...
#line 123
# 148 "../../lib/net/orinoco/OrinocoRadioP.nc"
static inline error_t OrinocoRadioP__OrinocoDI__appendBeacon(uint8_t laenge)
#line 148
{

  if (sizeof(OrinocoBeaconMsg ) - sizeof(orinoco_routing_t ) + laenge <= OrinocoRadioP__BeaconSubSend__maxPayloadLength()) 
    {

      OrinocoRadioP__extBeaconSize = sizeof(OrinocoBeaconMsg ) - sizeof(orinoco_routing_t ) + laenge;
      return SUCCESS;
    }

  OrinocoRadioP__extBeaconSize = sizeof(OrinocoBeaconMsg ) - sizeof(orinoco_routing_t );
  printf("%u,%lu: appB F \n", TOS_NODE_ID, OrinocoRadioP__LocalTime__get());
  printfflush();
  return FAIL;
}

# 9 "../../lib/net/orinoco/OrinocoDataInterface.nc"
inline static error_t RadioTestC__Orinoco__appendBeacon(uint8_t laenge){
#line 9
  unsigned char __nesc_result;
#line 9

#line 9
  __nesc_result = OrinocoRadioP__OrinocoDI__appendBeacon(laenge);
#line 9
...
inline static void *RadioTestC__Orinoco__getBeaconPayload(uint8_t len){
#line 10
  void *__nesc_result;
#line 10

#line 10
  __nesc_result = OrinocoRadioP__OrinocoDI__getBeaconPayload(len);
#line 10
...
#line 10
# 207 "../../lib/net/orinoco/RadioTestC.nc"
static inline void RadioTestC__Orinoco__aboutToSendBeacon(void )
#line 207
{
...
#line 208
  ...
  if (RadioTestC__isNew > 0) {

      CloudCoverHeader *data = (CloudCoverHeader *)RadioTestC__Orinoco__getBeaconPayload(RadioTestC__ccPackageLength);

#line 213
      if (data != (void *)0) {

          tempTime = RadioTestC__LocalTimeMilli__get() - RadioTestC__pStartTime;
          tempTime += RadioTestC__tsTime;


          __nesc_hton_uint16(data->header_ZLsb.nxdata, (uint16_t )(tempTime & 0xFFFF));
          tempTime = tempTime >> HEADER_TIME_MSB_OFFSET;

          __nesc_hton_uint8(data->header_ZMsbAM.nxdata, __nesc_ntoh_uint8(RadioTestC__paket.header_ZMsbAM.nxdata) & 192);
          (__nesc_temp56 = data->header_ZMsbAM.nxdata, __nesc_hton_uint8(__nesc_temp56, __nesc_ntoh_uint8(__nesc_temp56) + (uint8_t )(tempTime & HEADER_TIME_MSB)));


          __nesc_hton_uint8(data->header_VA.nxdata, __nesc_ntoh_uint8(RadioTestC__paket.header_VA.nxdata));
          memcpy(data->data, RadioTestC__paket.data, __nesc_ntoh_uint8(RadioTestC__paket.length.nxdata));

          __nesc_hton_uint8(data->data[3].nxdata, (uint8_t )TOS_NODE_ID);

          RadioTestC__Orinoco__appendBeacon(RadioTestC__ccPackageLength);
        }
      else 
...
# 7 "../../lib/net/orinoco/OrinocoDataInterface.nc"
inline static void OrinocoRadioP__OrinocoDI__aboutToSendBeacon(void ){
#line 7
  RadioTestC__Orinoco__aboutToSendBeacon();
#line 7
}
#line 7
# 285 "../../lib/net/orinoco/OrinocoRoutingP.nc"
static inline const orinoco_routing_t *OrinocoRoutingP__OrinocoRoutingInternal__getCurrentBloomFilter(void )
#line 285
{
  return &OrinocoRoutingP__curRouting_;
}

# 48 "../../interfaces/OrinocoRoutingInternal.nc"
inline static const orinoco_routing_t *OrinocoRadioP__Routing__getCurrentBloomFilter(void ){
#line 48
  nx_struct orinoco_routing_t const *__nesc_result;
#line 48

#line 48
  __nesc_result = OrinocoRoutingP__OrinocoRoutingInternal__getCurrentBloomFilter();
#line 48
...
#line 48
# 289 "../../lib/net/orinoco/OrinocoRoutingP.nc"
static inline uint16_t OrinocoRoutingP__OrinocoRoutingInternal__getRoutingVersionNumber(void )
#line 289
{
  return __nesc_ntoh_uint16(OrinocoRoutingP__curRouting_.version.nxdata);
}

# 51 "../../interfaces/OrinocoRoutingInternal.nc"
inline static uint16_t OrinocoRadioP__Routing__getRoutingVersionNumber(void ){
#line 51
  unsigned int __nesc_result;
#line 51

#line 51
  __nesc_result = OrinocoRoutingP__OrinocoRoutingInternal__getRoutingVersionNumber();
#line 51
...
#line 51
# 143 "../../lib/net/orinoco/OrinocoConfigP.nc"
static inline uint8_t OrinocoConfigP__OrinocoConfig__getQueueLocalReserve(void )
#line 143
{
...
#line 65
# 562 "../../lib/net/orinoco/OrinocoQueueP.nc"
static inline bool OrinocoQueueP__QueueStatus__acceptsRemote(void )
#line 562
{
...
#line 135
  __nesc_result = CC2420ActiveMessageP__AMSend__getPayload(ORINOCO_AM_BEACON, msg, len);
#line 135
...
#line 135
# 193 "../../lib/net/orinoco/OrinocoRadioP.nc"
static inline error_t OrinocoRadioP__sendBeacon(void )
#line 193
{
...
#line 210
  OrinocoRadioP__txBeaconDst_ != AM_BROADCAST_ADDR
   && OrinocoRadioP__txBeaconDst_ != OrinocoRadioP__lastBeaconDestination_
   && OrinocoRadioP__rxRouteVersion_ != OrinocoRadioP__Routing__getRoutingVersionNumber()) {

      p->route = *OrinocoRadioP__Routing__getCurrentBloomFilter();
      (__nesc_temp45 = p->flags.nxdata, __nesc_hton_uint8(__nesc_temp45, __nesc_ntoh_uint8(__nesc_temp45) | ORINOCO_BEACON_FLAGS_CONTAINSROUTE));
...
#line 225
  OrinocoRadioP__txBeaconDst_ != AM_BROADCAST_ADDR
   && OrinocoRadioP__txBeaconDst_ != OrinocoRadioP__lastBeaconDestination_) {
      OrinocoRadioP__OrinocoDI__aboutToSendBeacon();
      error = OrinocoRadioP__BeaconSubSend__send(OrinocoRadioP__txBeaconDst_, &OrinocoRadioP__txBeaconMsg_, OrinocoRadioP__extBeaconSize);
    }
  else 
#line 229
    {
      error = OrinocoRadioP__BeaconSubSend__send(OrinocoRadioP__txBeaconDst_, &OrinocoRadioP__txBeaconMsg_, beaconLength);
    }
#line 247
  if (error == SUCCESS) {
      OrinocoRadioP__lastBeaconDestination_ = OrinocoRadioP__txBeaconDst_;
    }
  ...
  if (error == SUCCESS) {
      if (sizeof(OrinocoBeaconMsg ) == beaconLength) {
          ...
          OrinocoRadioP__longBcnTxCount_++;
        }
      else 
#line 257
        {
          ...
          OrinocoRadioP__shortBcnTxCount_++;
        }
    }
  else 
#line 262
...
#line 80
# 165 "../../lib/net/orinoco/OrinocoRadioP.nc"
static inline error_t OrinocoRadioP__OrinocoDI__appendDataVer(void )
#line 165
{
  return FAIL;
...
# 5 "../../lib/net/orinoco/OrinocoDataInterface.nc"
inline static error_t RadioTestC__Orinoco__appendDataVer(void ){
#line 5
  unsigned char __nesc_result;
#line 5

#line 5
  __nesc_result = OrinocoRadioP__OrinocoDI__appendDataVer();
#line 5
...
#line 5
# 180 "../../lib/net/orinoco/OrinocoRadioP.nc"
static inline void *OrinocoRadioP__OrinocoDI__getDataPayload(void )
#line 180
{
  ...
  return OrinocoRadioP__SubPacket__getPayload(OrinocoRadioP__txDataMsg_, OrinocoRadioP__SubPacket__maxPayloadLength()) + OrinocoRadioP__Packet__payloadLength(OrinocoRadioP__txDataMsg_);
}

# 4 "../../lib/net/orinoco/OrinocoDataInterface.nc"
inline static void *RadioTestC__Orinoco__getDataPayload(void ){
#line 4
  void *__nesc_result;
#line 4

#line 4
  __nesc_result = OrinocoRadioP__OrinocoDI__getDataPayload();
#line 4
...
#line 4
# 149 "../../lib/net/orinoco/RadioTestC.nc"
static inline void RadioTestC__Orinoco__aboutToSendData(void )
#line 149
{
  uint8_t version = __nesc_ntoh_uint8(RadioTestC__paket.header_VA.nxdata) >> HEADER_VERSION_OFFSET;
  void *data = RadioTestC__Orinoco__getDataPayload();
...
#line 155
      *ver = version;
      ...
      RadioTestC__Orinoco__appendDataVer();
    }
  else 
    {
      printf("%u,%lu: AppDt F %u \n", TOS_NODE_ID, RadioTestC__LocalTimeMilli__get(), version);
      printfflush();
    }
}

# 2 "../../lib/net/orinoco/OrinocoDataInterface.nc"
inline static void OrinocoRadioP__OrinocoDI__aboutToSendData(void ){
#line 2
  RadioTestC__Orinoco__aboutToSendData();
#line 2
}
#line 2
# 59 "../../lib/net/orinoco/OrinocoTrafficUpdates.nc"
...
#line 54
# 114 "../../lib/net/orinoco/OrinocoConfigP.nc"
static inline uint8_t OrinocoConfigP__OrinocoConfig__getNumWaitingIntervals(void )
#line 114
{
...
# 78 "../../interfaces/OrinocoConfig.nc"
...
#line 78
# 344 "../../lib/net/orinoco/OrinocoRadioP.nc"
static __inline uint32_t OrinocoRadioP__getMaxWaitingTime(void )
#line 344
{
...
# 90 "../../lib/net/orinoco/OrinocoConfigP.nc"
static inline uint16_t OrinocoConfigP__OrinocoConfig__getAbsWakeUpDeviation(void )
#line 90
{
...
#line 60
# 77 "../../lib/net/orinoco/OrinocoConfigP.nc"
static inline uint16_t OrinocoConfigP__OrinocoConfig__getWakeUpInterval(void )
#line 77
{
...
# 47 "../../interfaces/OrinocoConfig.nc"
...
#line 52
# 338 "../../lib/net/orinoco/OrinocoRadioP.nc"
static __inline uint16_t OrinocoRadioP__getRandomSleepTime(void )
#line 338
{
  uint16_t rdev;
...
#line 113
# 98 "../../lib/net/orinoco/OrinocoConfigP.nc"
static inline uint8_t OrinocoConfigP__OrinocoConfig__getMinDwellTime(void )
#line 98
{
...
# 66 "../../interfaces/OrinocoConfig.nc"
            ...
            if (OrinocoRadioP__state_ == OrinocoRadioP__FORWARD_TIMER) {
              ...
              if (OrinocoRadioP__state_ == OrinocoRadioP__RECEIVE_TIMER) {
                ...
                if (OrinocoRadioP__state_ == OrinocoRadioP__FORWARD_SUBSEND) {
                    ...
                    OrinocoRadioP__OrinocoDI__aboutToSendData();
                    OrinocoRadioP__txDataError_ = OrinocoRadioP__DataSubSend__send(OrinocoRadioP__txDataDst_, OrinocoRadioP__txDataMsg_, OrinocoRadioP__txDataLen_ + OrinocoRadioP__VerSize__getVersionSize());
...
# 160 "../../lib/net/orinoco/OrinocoQueueP.nc"
static inline void OrinocoQueueP__sendTask__runTask(void )
#line 160
{
...
#line 65
# 229 "../../lib/net/orinoco/OrinocoQueueP.nc"
static inline error_t OrinocoQueueP__Init__init(void )
#line 229
{
...
# 56 "../../lib/net/orinoco/OrinocoConfigP.nc"
static inline void OrinocoConfigP__updateAbsDeviation(void )
#line 56
{
...
#line 60
{
  ...
  OrinocoConfigP__qlLvl_ = 30 / ORINOCO_DFLT_QUEUE_LOCAL_RESERVE;
  OrinocoConfigP__updateAbsDeviation();
  return SUCCESS;
}

# 157 "../../lib/net/orinoco/OrinocoRoutingP.nc"
static inline void OrinocoRoutingP__clearBloomFilter(void )
#line 157
{
  uint8_t i;
...
#line 159
  for (i = 0; i < BLOOM_BYTES; i++) {
      __nesc_hton_uint8(OrinocoRoutingP__curRouting_.bloom[i].nxdata, 0x00);
    }
}
...
#line 190
{
  ...
  __nesc_hton_uint16(OrinocoRoutingP__curRouting_.version.nxdata, 0);

  OrinocoRoutingP__clearBloomFilter();


  OrinocoRoutingP__packetWaiting_ = FALSE;
...
#line 67
  ...
  /*OrinocoP.MsgPool.PoolP*/PoolP__0__free = 30;
...
#line 62
  __nesc_result = ecombine(__nesc_result, OrinocoRoutingP__Init__init());
#line 62
...
#line 64
# 138 "../../lib/net/orinoco/RadioTestC.nc"
static inline void RadioTestC__Value__set(const CloudCoverMAX *val)
#line 138
{
  RadioTestC__paket = *val;
}

# 64 "/opt/tinyos-2.1.2/tos/lib/net/DisseminationValue.nc"
inline static void TestC__Value__set(const TestC__Value__t *arg_0x2b1f94f09e80){
#line 64
  RadioTestC__Value__set(arg_0x2b1f94f09e80);
#line 64
}
#line 64
# 46 "/opt/tinyos-2.1.2/tos/interfaces/Random.nc"
inline static uint32_t TestC__Random__rand32(void ){
#line 46
  unsigned long __nesc_result;
#line 46
...
#line 46
# 73 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void TestC__BootTimer__startOneShot(uint32_t dt){
#line 73
  /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__startOneShot(5U, dt);
#line 73
}
#line 73
# 118 "../../lib/net/orinoco/OrinocoConfigP.nc"
static inline error_t OrinocoConfigP__OrinocoConfig__setMinQueueSize(uint8_t m)
#line 118
{
  ...
  OrinocoConfigP__qmLvl_ = m;
  return SUCCESS;
}

# 81 "../../interfaces/OrinocoConfig.nc"
inline static error_t TestC__OrinocoConfig__setMinQueueSize(uint8_t m){
#line 81
  unsigned char __nesc_result;
#line 81

#line 81
  __nesc_result = OrinocoConfigP__OrinocoConfig__setMinQueueSize(m);
#line 81
...
#line 81
# 72 "../../lib/net/orinoco/OrinocoConfigP.nc"
static inline void OrinocoConfigP__OrinocoConfig__setWakeUpInterval(uint16_t Ts)
#line 72
{
...
# 44 "../../interfaces/OrinocoConfig.nc"
inline static void TestC__OrinocoConfig__setWakeUpInterval(uint16_t Ts){
#line 44
  OrinocoConfigP__OrinocoConfig__setWakeUpInterval(Ts);
#line 44
}
#line 44
# 238 "../../lib/net/orinoco/OrinocoQueueP.nc"
static inline error_t OrinocoQueueP__StdControl__start(void )
#line 238
{
...
# 95 "/opt/tinyos-2.1.2/tos/interfaces/StdControl.nc"
inline static error_t TestC__ForwardingControl__start(void ){
#line 95
  unsigned char __nesc_result;
#line 95
...
#line 95
# 509 "../../lib/net/orinoco/OrinocoRadioP.nc"
static inline error_t OrinocoRadioP__SplitControl__start(void )
#line 509
{
...
#line 104
# 256 "../../lib/net/orinoco/OrinocoQueueP.nc"
static inline error_t OrinocoQueueP__RootControl__unsetRoot(void )
#line 256
{
  OrinocoQueueP__isRoot_ = FALSE;
  return SUCCESS;
}

# 42 "/opt/tinyos-2.1.2/tos/lib/net/RootControl.nc"
inline static error_t TestC__RootControl__unsetRoot(void ){
#line 42
  unsigned char __nesc_result;
#line 42

#line 42
  __nesc_result = OrinocoQueueP__RootControl__unsetRoot();
#line 42
...
#line 98
{
  ...
  TestC__RootControl__unsetRoot();


  TestC__RadioControl__start();
  TestC__ForwardingControl__start();

  TestC__OrinocoConfig__setWakeUpInterval(768);
  TestC__OrinocoConfig__setMinQueueSize(1);


  TestC__BootTimer__startOneShot(1024);


  TestC__Timer__startOneShot(1 + TestC__Random__rand32() % TestC__delay);

  TestC__Value__set(&TestC__defPackage);
}

# 76 "../../lib/net/orinoco/OrinocoRoutingP.nc"
static inline uint8_t OrinocoRoutingP__calcHash(am_addr_t address, uint8_t salt)
#line 76
{
  uint32_t data = salt;
...
# 50 "/opt/tinyos-2.1.2/tos/interfaces/ActiveMessageAddress.nc"
inline static am_addr_t OrinocoRoutingP__AMA__amAddress(void ){
#line 50
  unsigned int __nesc_result;
#line 50
...
#line 50
# 95 "../../lib/net/orinoco/OrinocoRoutingP.nc"
static inline void OrinocoRoutingP__updateHashes(void )
#line 95
{
  uint8_t i;

  OrinocoRoutingP__localId_ = OrinocoRoutingP__AMA__amAddress();
  for (i = 0; i < BLOOM_HASHES; i++) {
      OrinocoRoutingP__bp_.hashes[i] = OrinocoRoutingP__calcHash(OrinocoRoutingP__localId_, i);
    }
}
...
# 54 "/opt/tinyos-2.1.2/tos/chips/msp430/usart/HplMsp430UsartInterrupts.nc"
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__Interrupts__rxDone(uint8_t arg_0x2b1f95a62800, uint8_t data){
#line 54
  switch (arg_0x2b1f95a62800) {
#line 54
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
#line 54
...
#line 54
    default:
#line 54
      /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__Interrupts__default__rxDone(arg_0x2b1f95a62800, data);
#line 54
      break;
#line 54
    }
...
# 39 "/opt/tinyos-2.1.2/tos/chips/msp430/usart/HplMsp430I2CInterrupts.nc"
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__I2CInterrupts__fired(uint8_t arg_0x2b1f95a61620){
#line 39
    /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__I2CInterrupts__default__fired(arg_0x2b1f95a61620);
#line 39
}
#line 39
...
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__Interrupts__txDone(uint8_t arg_0x2b1f95a62800){
#line 49
  switch (arg_0x2b1f95a62800) {
#line 49
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
...
#line 49
    default:
#line 49
      /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__Interrupts__default__txDone(arg_0x2b1f95a62800);
#line 49
      break;
#line 49
    }
...
# 79 "/opt/tinyos-2.1.2/tos/interfaces/UartStream.nc"
inline static void /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__receivedByte(uint8_t arg_0x2b1f9658d7e0, uint8_t byte){
#line 79
  switch (arg_0x2b1f9658d7e0) {
#line 79
    case /*PlatformSerialC.UartC*/Msp430Uart1C__0__CLIENT_ID:
#line 79
...
#line 79
    default:
#line 79
      /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__default__receivedByte(arg_0x2b1f9658d7e0, byte);
#line 79
      break;
#line 79
    }
...
inline static void /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__receiveDone(uint8_t arg_0x2b1f9658d7e0, uint8_t * buf, uint16_t len, error_t error){
#line 99
  switch (arg_0x2b1f9658d7e0) {
#line 99
    case /*PlatformSerialC.UartC*/Msp430Uart1C__0__CLIENT_ID:
...
#line 99
    default:
#line 99
      /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__default__receiveDone(arg_0x2b1f9658d7e0, buf, len, error);
#line 99
      break;
#line 99
    }
...
# 54 "/opt/tinyos-2.1.2/tos/chips/msp430/usart/HplMsp430UsartInterrupts.nc"
inline static void /*Msp430UsartShare1P.UsartShareP*/Msp430UsartShareP__1__Interrupts__rxDone(uint8_t arg_0x2b1f95a62800, uint8_t data){
#line 54
  switch (arg_0x2b1f95a62800) {
#line 54
    case /*PlatformSerialC.UartC.UsartC*/Msp430Usart1C__0__CLIENT_ID:
...
#line 54
    default:
#line 54
      /*Msp430UsartShare1P.UsartShareP*/Msp430UsartShareP__1__Interrupts__default__rxDone(arg_0x2b1f95a62800, data);
#line 54
      break;
#line 54
    }
...
inline static void /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__sendDone(uint8_t arg_0x2b1f9658d7e0, uint8_t * buf, uint16_t len, error_t error){
#line 57
  switch (arg_0x2b1f9658d7e0) {
#line 57
    case /*PlatformSerialC.UartC*/Msp430Uart1C__0__CLIENT_ID:
...
#line 57
    default:
#line 57
      /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__default__sendDone(arg_0x2b1f9658d7e0, buf, len, error);
#line 57
      break;
#line 57
    }
...
# 49 "/opt/tinyos-2.1.2/tos/chips/msp430/usart/HplMsp430UsartInterrupts.nc"
inline static void /*Msp430UsartShare1P.UsartShareP*/Msp430UsartShareP__1__Interrupts__txDone(uint8_t arg_0x2b1f95a62800){
#line 49
  switch (arg_0x2b1f95a62800) {
#line 49
    case /*PlatformSerialC.UartC.UsartC*/Msp430Usart1C__0__CLIENT_ID:
...
#line 49
    default:
#line 49
      /*Msp430UsartShare1P.UsartShareP*/Msp430UsartShareP__1__Interrupts__default__txDone(arg_0x2b1f95a62800);
#line 49
      break;
#line 49
    }
...
# 39 "/opt/tinyos-2.1.2/tos/chips/msp430/timer/Msp430TimerEvent.nc"
static void /*Msp430TimerC.Msp430TimerB*/Msp430TimerP__1__Event__fired(uint8_t arg_0x2b1f94d8edc8){
#line 39
  switch (arg_0x2b1f94d8edc8) {
#line 39
    case 0:
...
#line 39
    default:
#line 39
      /*Msp430TimerC.Msp430TimerB*/Msp430TimerP__1__Event__default__fired(arg_0x2b1f94d8edc8);
#line 39
      break;
#line 39
    }
...
# 75 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
static void SchedulerBasicP__TaskBasic__runTask(uint8_t arg_0x2b1f94c49650){
#line 75
  switch (arg_0x2b1f94c49650) {
#line 75
...
#line 75
      break;
#line 75
    case RadioTestC__decodingTask:
#line 75
      RadioTestC__decodingTask__runTask();
#line 75
      break;
#line 75
    case RadioTestC__changedTask:
#line 75
      RadioTestC__changedTask__runTask();
#line 75
      break;
#line 75
...
#line 75
    default:
#line 75
      SchedulerBasicP__TaskBasic__default__runTask(arg_0x2b1f94c49650);
#line 75
      break;
#line 75
    }
...
#line 42
{
  ...
  uint8_t shift;
  uint8_t i;
  uint16_t limit = size * MAX_CODE - 1;
  ...
  for (i = 0; i < offset; i++) {
      ...
      index = *pos / MAX_BIT;
      bit = MAX_BIT - 1 - *pos % MAX_BIT;
      shift = 1 << bit;
      ausgabe = ausgabe << 1;
      ;
      ;
      ;
      if (__nesc_ntoh_uint8(stream[index].nxdata) & shift) {
          ausgabe += 1;
        }
...
# 1040 "../../lib/net/orinoco/OrinocoRadioP.nc"
static void OrinocoRadioP__DataSubSend__sendDone(message_t *msg, error_t error)
#line 1040
{
#line 1072
...
#line 56
# 1008 "../../lib/net/orinoco/OrinocoRadioP.nc"
static void OrinocoRadioP__BeaconSubSend__sendDone(message_t *msg, error_t error)
#line 1008
{
...
# 115 "../../lib/net/orinoco/OrinocoPacketDelayLayerP.nc"
static void OrinocoPacketDelayLayerP__SubAMSend__sendDone(message_t *msg, error_t error)
#line 115
{
  OrinocoPacketDelayLayerP__busy = FALSE;
...
# 276 "../../lib/net/orinoco/OrinocoQueueP.nc"
static error_t OrinocoQueueP__Send__send(collection_id_t type, message_t *msg, uint8_t len)
#line 276
{
  ...
  if (len > OrinocoQueueP__Send__maxPayloadLength(type)) {
      return ESIZE;
    }


  OrinocoQueueP__TrafficUpdates__updatePktCreationIntvl();


  if (OrinocoQueueP__SendQueue__size() == OrinocoQueueP__SendQueue__maxSize()) {
  ...
  qe.msg = OrinocoQueueP__MsgPool__get();
  if (qe.msg == (void *)0) {
  ...
  OrinocoQueueP__Packet__setPayloadLength(msg, len);
  h = OrinocoQueueP__getHeader(msg);
  __nesc_hton_uint16(h->origin.nxdata, TOS_NODE_ID);
  __nesc_hton_uint8(h->seqno.nxdata, OrinocoQueueP__seqno_++);
  __nesc_hton_uint8(h->hopCnt.nxdata, 0);



  __nesc_hton_uint8(h->type.nxdata, type);
  __nesc_hton_uint16(h->routingVersion.nxdata, OrinocoQueueP__routingVersion_);
  ...
  OrinocoQueueP__PacketDelayMilli__init(msg);


  if (OrinocoQueueP__SendQueue__enqueue(qe) == SUCCESS) {
      if (OrinocoQueueP__RootControl__isRoot()) {
          OrinocoQueueP__selfReceiveTask__postTask();
        }
      else 
...
# 148 "../../lib/net/orinoco/OrinocoPacketDelayLayerP.nc"
static uint8_t OrinocoPacketDelayLayerP__Packet__maxPayloadLength(void )
#line 148
{
...
#line 91
      ...
      if (/*OrinocoP.MsgPool.PoolP*/PoolP__0__index == 30) {
          /*OrinocoP.MsgPool.PoolP*/PoolP__0__index = 0;
        }
      ;
      return rval;
...
# 126 "../../lib/net/orinoco/OrinocoQueueP.nc"
static orinoco_data_header_t *OrinocoQueueP__getHeader(message_t *msg)
#line 126
{
...
#line 97
{
  if (/*OrinocoP.SendQueue*/QueueC__0__Queue__size() < /*OrinocoP.SendQueue*/QueueC__0__Queue__maxSize()) {
      ...
      if (/*OrinocoP.SendQueue*/QueueC__0__tail == 30) {
#line 102
...
#line 149
      __nesc_hton_uint16(hdr->routingVersion.nxdata, OrinocoQueueP__routingVersion_);
...
#line 103
{
  if (/*OrinocoP.MsgPool.PoolP*/PoolP__0__free >= 30) {
      return FAIL;
    }
  else {
...
#line 826
              ...
              OrinocoRadioP__OrinocoDI__receivedBeacon(payload + (sizeof(OrinocoBeaconMsg ) - sizeof(orinoco_routing_t )), len - (sizeof(OrinocoBeaconMsg ) - sizeof(orinoco_routing_t )));
...
# 113 "../../lib/net/orinoco/OrinocoTrafficStatisticsP.nc"
static void OrinocoTrafficStatisticsP__Updates__updateTxBurst(bool end)
#line 113
{
  if (end) {
...
#line 198
  if (OrinocoTrafficStatisticsP__tv_.curTxBurstLen == 1) {
      OrinocoTrafficStatisticsP__ts_.avgForwardDelay = ewmaFilter32(OrinocoTrafficStatisticsP__ts_.avgForwardDelay, now - OrinocoTrafficStatisticsP__tv_.curForwardBegin, OrinocoTrafficStatisticsP__EWMA_FILTER);
    }
  if (reset) {
      OrinocoTrafficStatisticsP__tv_.curForwardBegin = now;
    }
}

# 291 "../../lib/net/orinoco/OrinocoRadioP.nc"
static bool OrinocoRadioP__processBeacon(message_t *msg, bool update)
#line 291
{
  bool accept = FALSE;
  ...
  if (TRUE) {
      ...
      if (__nesc_ntoh_uint8(p->flags.nxdata) & ORINOCO_BEACON_FLAGS_CONTAINSROUTE) {
          OrinocoRadioP__Routing__updateBloomFilter(& p->route);
          OrinocoRadioP__RoutingState__setRoutingInformationVersion(OrinocoRadioP__Routing__getRoutingVersionNumber());
        }
    }
...
# 126 "/opt/tinyos-2.1.2/tos/interfaces/Packet.nc"
static void * OrinocoRoutingP__Packet__getPayload(message_t * msg, uint8_t len){
#line 126
  void *__nesc_result;
#line 126
...
# 147 "../../lib/net/orinoco/OrinocoTrafficStatisticsP.nc"
static void OrinocoTrafficStatisticsP__Updates__updateRxBurst(bool end)
#line 147
{
  if (end) {
...
#line 133
  printf("%u,%lu: data-rx %u %u %u %u\n", TOS_NODE_ID, TestC__LocalTime__get(), TestC__CollectionPacket__getOrigin(msg), type, __nesc_ntoh_uint16((* (nx_uint16_t *)payload).nxdata), hops);
  printfflush();
...
# 171 "../../lib/net/orinoco/OrinocoRadioP.nc"
static void *OrinocoRadioP__OrinocoDI__getBeaconPayload(uint8_t len)
#line 171
{
  uint8_t bSize = sizeof(OrinocoBeaconMsg ) - sizeof(orinoco_routing_t );

  return OrinocoRadioP__BeaconSubSend__getPayload(&OrinocoRadioP__txBeaconMsg_, bSize + len) + bSize;
}
